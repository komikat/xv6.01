...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3a8:	48c50513          	add	a0,a0,1164 # 830 <digits>
 3ac:	883a                	mv	a6,a4
 3ae:	2705                	addw	a4,a4,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4a4:	00271793          	sll	a5,a4,0x2
 4a8:	00000717          	auipc	a4,0x0
 4ac:	33070713          	add	a4,a4,816 # 7d8 <malloc+0xf8>
 ...
 536:	2feb8b93          	add	s7,s7,766 # 830 <digits>
 ...
 58a:	24a90913          	add	s2,s2,586 # 7d0 <malloc+0xf0>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 73c:	8d878793          	add	a5,a5,-1832 # 1010 <base>
 ...
 758:	c798                	sw	a4,8(a5)
        p += p->s.size;
 75a:	02071693          	sll	a3,a4,0x20
 75e:	01c6d713          	srl	a4,a3,0x1c
 ...
 7ba:	b82080e7          	jalr	-1150(ra) # 338 <sbrk>
  if(p == (char*)-1)
