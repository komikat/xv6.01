...
main(){
  ...
  16:	7be50513          	add	a0,a0,1982 # 7d0 <malloc+0xee>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3aa:	49250513          	add	a0,a0,1170 # 838 <digits>
 3ae:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4ae:	33670713          	add	a4,a4,822 # 7e0 <malloc+0xfe>
 ...
 538:	304b8b93          	add	s7,s7,772 # 838 <digits>
 ...
 58c:	25090913          	add	s2,s2,592 # 7d8 <malloc+0xf6>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 732:	8d290913          	add	s2,s2,-1838 # 1000 <freep>
  if(p == (char*)-1)
 736:	5afd                	li	s5,-1
 738:	a895                	j	7ac <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 73a:	00001797          	auipc	a5,0x1
 73e:	8d678793          	add	a5,a5,-1834 # 1010 <base>
