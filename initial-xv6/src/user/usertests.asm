...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	07250513          	add	a0,a0,114 # 60b0 <malloc+0xf2>
      46:	00006097          	auipc	ra,0x6
      4a:	ec0080e7          	jalr	-320(ra) # 5f06 <printf>
      exit(1);
      4e:	4505                	li	a0,1
      ...
      74:	8082                	ret
{
      ...
      84:	05050513          	add	a0,a0,80 # 60d0 <malloc+0x112>
      88:	00006097          	auipc	ra,0x6
      8c:	e7e080e7          	jalr	-386(ra) # 5f06 <printf>
      exit(1);
      90:	4505                	li	a0,1
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	04050513          	add	a0,a0,64 # 60e8 <malloc+0x12a>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	04250513          	add	a0,a0,66 # 6108 <malloc+0x14a>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	00a50513          	add	a0,a0,10 # 60f0 <malloc+0x132>
      ee:	00006097          	auipc	ra,0x6
      f2:	e18080e7          	jalr	-488(ra) # 5f06 <printf>
    exit(1);
      f6:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	01650513          	add	a0,a0,22 # 6118 <malloc+0x15a>
     10a:	00006097          	auipc	ra,0x6
     10e:	dfc080e7          	jalr	-516(ra) # 5f06 <printf>
    exit(1);
     112:	4505                	li	a0,1
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	01450513          	add	a0,a0,20 # 6140 <malloc+0x182>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	ffc58593          	add	a1,a1,-4 # 6150 <malloc+0x192>
     15c:	00006097          	auipc	ra,0x6
     160:	a52080e7          	jalr	-1454(ra) # 5bae <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	fd850513          	add	a0,a0,-40 # 6140 <malloc+0x182>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	fdc58593          	add	a1,a1,-36 # 6158 <malloc+0x19a>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	fac50513          	add	a0,a0,-84 # 6140 <malloc+0x182>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	f9650513          	add	a0,a0,-106 # 6160 <malloc+0x1a2>
     1d2:	00006097          	auipc	ra,0x6
     1d6:	d34080e7          	jalr	-716(ra) # 5f06 <printf>
    exit(1);
     1da:	4505                	li	a0,1
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	f0c50513          	add	a0,a0,-244 # 6188 <malloc+0x1ca>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	ef8a8a93          	add	s5,s5,-264 # 6188 <malloc+0x1ca>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	e8650513          	add	a0,a0,-378 # 6198 <malloc+0x1da>
     31a:	00006097          	auipc	ra,0x6
     31e:	bec080e7          	jalr	-1044(ra) # 5f06 <printf>
      exit(1);
     322:	4505                	li	a0,1
     ...
     338:	e8450513          	add	a0,a0,-380 # 61b8 <malloc+0x1fa>
     33c:	00006097          	auipc	ra,0x6
     340:	bca080e7          	jalr	-1078(ra) # 5f06 <printf>
        exit(1);
     344:	4505                	li	a0,1
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     362:	e7250513          	add	a0,a0,-398 # 61d0 <malloc+0x212>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     376:	e5e98993          	add	s3,s3,-418 # 61d0 <malloc+0x212>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     3c2:	e1250513          	add	a0,a0,-494 # 61d0 <malloc+0x212>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     3da:	d8258593          	add	a1,a1,-638 # 6158 <malloc+0x19a>
    ...
    printf("write failed\n");
     ...
     3f0:	e0450513          	add	a0,a0,-508 # 61f0 <malloc+0x232>
     3f4:	00006097          	auipc	ra,0x6
     3f8:	b12080e7          	jalr	-1262(ra) # 5f06 <printf>
    exit(1);
     3fc:	4505                	li	a0,1
     ...
     40a:	dd250513          	add	a0,a0,-558 # 61d8 <malloc+0x21a>
     40e:	00006097          	auipc	ra,0x6
     412:	af8080e7          	jalr	-1288(ra) # 5f06 <printf>
      exit(1);
     416:	4505                	li	a0,1
    ...
    printf("open junk failed\n");
     ...
     424:	db850513          	add	a0,a0,-584 # 61d8 <malloc+0x21a>
     428:	00006097          	auipc	ra,0x6
     42c:	ade080e7          	jalr	-1314(ra) # 5f06 <printf>
    exit(1);
     430:	4505                	li	a0,1
  ...
  unlink("junk");
     ...
     448:	d8c50513          	add	a0,a0,-628 # 61d0 <malloc+0x212>
...
000000000000052e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     554:	cb0a0a13          	add	s4,s4,-848 # 6200 <malloc+0x242>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     600:	c0c50513          	add	a0,a0,-1012 # 6208 <malloc+0x24a>
     604:	00006097          	auipc	ra,0x6
     608:	902080e7          	jalr	-1790(ra) # 5f06 <printf>
      exit(1);
     60c:	4505                	li	a0,1
     ...
     61e:	c0650513          	add	a0,a0,-1018 # 6220 <malloc+0x262>
     622:	00006097          	auipc	ra,0x6
     626:	8e4080e7          	jalr	-1820(ra) # 5f06 <printf>
      exit(1);
     62a:	4505                	li	a0,1
     ...
     63c:	c1850513          	add	a0,a0,-1000 # 6250 <malloc+0x292>
     640:	00006097          	auipc	ra,0x6
     644:	8c6080e7          	jalr	-1850(ra) # 5f06 <printf>
      exit(1);
     648:	4505                	li	a0,1
     ...
     656:	c2e50513          	add	a0,a0,-978 # 6280 <malloc+0x2c2>
     65a:	00006097          	auipc	ra,0x6
     65e:	8ac080e7          	jalr	-1876(ra) # 5f06 <printf>
      exit(1);
     662:	4505                	li	a0,1
     ...
     674:	c2050513          	add	a0,a0,-992 # 6290 <malloc+0x2d2>
     678:	00006097          	auipc	ra,0x6
     67c:	88e080e7          	jalr	-1906(ra) # 5f06 <printf>
      exit(1);
     680:	4505                	li	a0,1
...
000000000000068a <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6b2:	c12a0a13          	add	s4,s4,-1006 # 62c0 <malloc+0x302>
    n = write(fds[1], "x", 1);
     6b6:	00006a97          	auipc	s5,0x6
     6ba:	aa2a8a93          	add	s5,s5,-1374 # 6158 <malloc+0x19a>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     760:	b6c50513          	add	a0,a0,-1172 # 62c8 <malloc+0x30a>
     764:	00005097          	auipc	ra,0x5
     768:	7a2080e7          	jalr	1954(ra) # 5f06 <printf>
      exit(1);
     76c:	4505                	li	a0,1
     ...
     77e:	b6650513          	add	a0,a0,-1178 # 62e0 <malloc+0x322>
     782:	00005097          	auipc	ra,0x5
     786:	784080e7          	jalr	1924(ra) # 5f06 <printf>
      exit(1);
     78a:	4505                	li	a0,1
     ...
     798:	aec50513          	add	a0,a0,-1300 # 6280 <malloc+0x2c2>
     79c:	00005097          	auipc	ra,0x5
     7a0:	76a080e7          	jalr	1898(ra) # 5f06 <printf>
      exit(1);
     7a4:	4505                	li	a0,1
     ...
     7b2:	b6250513          	add	a0,a0,-1182 # 6310 <malloc+0x352>
     7b6:	00005097          	auipc	ra,0x5
     7ba:	750080e7          	jalr	1872(ra) # 5f06 <printf>
      exit(1);
     7be:	4505                	li	a0,1
     ...
     7d0:	b5c50513          	add	a0,a0,-1188 # 6328 <malloc+0x36a>
     7d4:	00005097          	auipc	ra,0x5
     7d8:	732080e7          	jalr	1842(ra) # 5f06 <printf>
      exit(1);
     7dc:	4505                	li	a0,1
...
00000000000007e6 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     826:	92e58593          	add	a1,a1,-1746 # 6150 <malloc+0x192>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     842:	90250513          	add	a0,a0,-1790 # 6140 <malloc+0x182>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     86e:	8d650513          	add	a0,a0,-1834 # 6140 <malloc+0x182>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     882:	8c250513          	add	a0,a0,-1854 # 6140 <malloc+0x182>
  ...
  write(fd1, "abcdef", 6);
     ...
     8c0:	afc58593          	add	a1,a1,-1284 # 63b8 <malloc+0x3fa>
     8c4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     902:	84250513          	add	a0,a0,-1982 # 6140 <malloc+0x182>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     946:	a1650513          	add	a0,a0,-1514 # 6358 <malloc+0x39a>
     94a:	00005097          	auipc	ra,0x5
     94e:	5bc080e7          	jalr	1468(ra) # 5f06 <printf>
    exit(1);
     952:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     962:	a1a50513          	add	a0,a0,-1510 # 6378 <malloc+0x3ba>
     966:	00005097          	auipc	ra,0x5
     96a:	5a0080e7          	jalr	1440(ra) # 5f06 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     96e:	8652                	mv	a2,s4
     970:	85d6                	mv	a1,s5
     972:	00006517          	auipc	a0,0x6
     976:	a1650513          	add	a0,a0,-1514 # 6388 <malloc+0x3ca>
     97a:	00005097          	auipc	ra,0x5
     97e:	58c080e7          	jalr	1420(ra) # 5f06 <printf>
    exit(1);
     982:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     992:	a1a50513          	add	a0,a0,-1510 # 63a8 <malloc+0x3ea>
     996:	00005097          	auipc	ra,0x5
     99a:	570080e7          	jalr	1392(ra) # 5f06 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     99e:	8652                	mv	a2,s4
     9a0:	85d6                	mv	a1,s5
     9a2:	00006517          	auipc	a0,0x6
     9a6:	9e650513          	add	a0,a0,-1562 # 6388 <malloc+0x3ca>
     9aa:	00005097          	auipc	ra,0x5
     9ae:	55c080e7          	jalr	1372(ra) # 5f06 <printf>
    exit(1);
     9b2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9c4:	a0050513          	add	a0,a0,-1536 # 63c0 <malloc+0x402>
     9c8:	00005097          	auipc	ra,0x5
     9cc:	53e080e7          	jalr	1342(ra) # 5f06 <printf>
    exit(1);
     9d0:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9e2:	a0250513          	add	a0,a0,-1534 # 63e0 <malloc+0x422>
     9e6:	00005097          	auipc	ra,0x5
     9ea:	520080e7          	jalr	1312(ra) # 5f06 <printf>
    exit(1);
     9ee:	4505                	li	a0,1
...
00000000000009f8 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a16:	9ee50513          	add	a0,a0,-1554 # 6400 <malloc+0x442>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a2e:	9fe98993          	add	s3,s3,-1538 # 6428 <malloc+0x46a>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     a32:	00006a97          	auipc	s5,0x6
     a36:	a2ea8a93          	add	s5,s5,-1490 # 6460 <malloc+0x4a2>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     a7c:	98850513          	add	a0,a0,-1656 # 6400 <malloc+0x442>
  ...
  if(unlink("small") < 0){
     ...
     ab8:	94c50513          	add	a0,a0,-1716 # 6400 <malloc+0x442>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     ae2:	92a50513          	add	a0,a0,-1750 # 6408 <malloc+0x44a>
     ae6:	00005097          	auipc	ra,0x5
     aea:	420080e7          	jalr	1056(ra) # 5f06 <printf>
    exit(1);
     aee:	4505                	li	a0,1
     ...
     b00:	93c50513          	add	a0,a0,-1732 # 6438 <malloc+0x47a>
     b04:	00005097          	auipc	ra,0x5
     b08:	402080e7          	jalr	1026(ra) # 5f06 <printf>
      exit(1);
     b0c:	4505                	li	a0,1
     ...
     b1e:	95650513          	add	a0,a0,-1706 # 6470 <malloc+0x4b2>
     b22:	00005097          	auipc	ra,0x5
     b26:	3e4080e7          	jalr	996(ra) # 5f06 <printf>
      exit(1);
     b2a:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b3a:	96250513          	add	a0,a0,-1694 # 6498 <malloc+0x4da>
     b3e:	00005097          	auipc	ra,0x5
     b42:	3c8080e7          	jalr	968(ra) # 5f06 <printf>
    exit(1);
     b46:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     b56:	96650513          	add	a0,a0,-1690 # 64b8 <malloc+0x4fa>
     b5a:	00005097          	auipc	ra,0x5
     b5e:	3ac080e7          	jalr	940(ra) # 5f06 <printf>
    exit(1);
     b62:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b72:	96250513          	add	a0,a0,-1694 # 64d0 <malloc+0x512>
     b76:	00005097          	auipc	ra,0x5
     b7a:	390080e7          	jalr	912(ra) # 5f06 <printf>
    exit(1);
     b7e:	4505                	li	a0,1
...
0000000000000b88 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     ba4:	95050513          	add	a0,a0,-1712 # 64f0 <malloc+0x532>
  ...
  fd = open("big", O_RDONLY);
     ...
     bf6:	8fe50513          	add	a0,a0,-1794 # 64f0 <malloc+0x532>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c3e:	8be50513          	add	a0,a0,-1858 # 64f8 <malloc+0x53a>
     c42:	00005097          	auipc	ra,0x5
     c46:	2c4080e7          	jalr	708(ra) # 5f06 <printf>
    exit(1);
     c4a:	4505                	li	a0,1
     ...
     c5c:	8c050513          	add	a0,a0,-1856 # 6518 <malloc+0x55a>
     c60:	00005097          	auipc	ra,0x5
     c64:	2a6080e7          	jalr	678(ra) # 5f06 <printf>
      exit(1);
     c68:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c78:	8cc50513          	add	a0,a0,-1844 # 6540 <malloc+0x582>
     c7c:	00005097          	auipc	ra,0x5
     c80:	28a080e7          	jalr	650(ra) # 5f06 <printf>
    exit(1);
     c84:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ca4:	85050513          	add	a0,a0,-1968 # 64f0 <malloc+0x532>
     ...
     cd0:	89450513          	add	a0,a0,-1900 # 6560 <malloc+0x5a2>
     cd4:	00005097          	auipc	ra,0x5
     cd8:	232080e7          	jalr	562(ra) # 5f06 <printf>
        exit(1);
     cdc:	4505                	li	a0,1
     ...
     cee:	89e50513          	add	a0,a0,-1890 # 6588 <malloc+0x5ca>
     cf2:	00005097          	auipc	ra,0x5
     cf6:	214080e7          	jalr	532(ra) # 5f06 <printf>
      exit(1);
     cfa:	4505                	li	a0,1
     ...
     d0c:	89850513          	add	a0,a0,-1896 # 65a0 <malloc+0x5e2>
     d10:	00005097          	auipc	ra,0x5
     d14:	1f6080e7          	jalr	502(ra) # 5f06 <printf>
      exit(1);
     d18:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d28:	8a450513          	add	a0,a0,-1884 # 65c8 <malloc+0x60a>
     d2c:	00005097          	auipc	ra,0x5
     d30:	1da080e7          	jalr	474(ra) # 5f06 <printf>
    exit(1);
     d34:	4505                	li	a0,1
...
0000000000000d3e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d56:	88e50513          	add	a0,a0,-1906 # 65e0 <malloc+0x622>
  ...
  write(fd, "hello", SZ);
     ...
     d6e:	8a658593          	add	a1,a1,-1882 # 6610 <malloc+0x652>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d8a:	85a50513          	add	a0,a0,-1958 # 65e0 <malloc+0x622>
  ...
  if(unlink("unlinkread") != 0){
     ...
     da0:	84450513          	add	a0,a0,-1980 # 65e0 <malloc+0x622>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     db6:	82e50513          	add	a0,a0,-2002 # 65e0 <malloc+0x622>
  ...
  write(fd1, "yyy", 3);
     ...
     dca:	89258593          	add	a1,a1,-1902 # 6658 <malloc+0x69a>
  ...
  unlink("unlinkread");
     ...
     e32:	7b250513          	add	a0,a0,1970 # 65e0 <malloc+0x622>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e52:	7a250513          	add	a0,a0,1954 # 65f0 <malloc+0x632>
     e56:	00005097          	auipc	ra,0x5
     e5a:	0b0080e7          	jalr	176(ra) # 5f06 <printf>
    exit(1);
     e5e:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e6e:	7ae50513          	add	a0,a0,1966 # 6618 <malloc+0x65a>
     e72:	00005097          	auipc	ra,0x5
     e76:	094080e7          	jalr	148(ra) # 5f06 <printf>
    exit(1);
     e7a:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e8a:	7b250513          	add	a0,a0,1970 # 6638 <malloc+0x67a>
     e8e:	00005097          	auipc	ra,0x5
     e92:	078080e7          	jalr	120(ra) # 5f06 <printf>
    exit(1);
     e96:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     ea6:	7be50513          	add	a0,a0,1982 # 6660 <malloc+0x6a2>
     eaa:	00005097          	auipc	ra,0x5
     eae:	05c080e7          	jalr	92(ra) # 5f06 <printf>
    exit(1);
     eb2:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ec2:	7c250513          	add	a0,a0,1986 # 6680 <malloc+0x6c2>
     ec6:	00005097          	auipc	ra,0x5
     eca:	040080e7          	jalr	64(ra) # 5f06 <printf>
    exit(1);
     ece:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ede:	7c650513          	add	a0,a0,1990 # 66a0 <malloc+0x6e2>
     ee2:	00005097          	auipc	ra,0x5
     ee6:	024080e7          	jalr	36(ra) # 5f06 <printf>
    exit(1);
     eea:	4505                	li	a0,1
...
0000000000000ef4 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f42:	6d258593          	add	a1,a1,1746 # 6610 <malloc+0x652>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     f62:	76a58593          	add	a1,a1,1898 # 66c8 <malloc+0x70a>
     f66:	00005517          	auipc	a0,0x5
     f6a:	75a50513          	add	a0,a0,1882 # 66c0 <malloc+0x702>
  ...
  unlink("lf1");
     ...
     f7e:	74650513          	add	a0,a0,1862 # 66c0 <malloc+0x702>
     f82:	00005097          	auipc	ra,0x5
     f86:	c5c080e7          	jalr	-932(ra) # 5bde <unlink>
  if(open("lf1", 0) >= 0){
     f8a:	4581                	li	a1,0
     f8c:	00005517          	auipc	a0,0x5
     f90:	73450513          	add	a0,a0,1844 # 66c0 <malloc+0x702>
  ...
  fd = open("lf2", 0);
     ...
     fa6:	72650513          	add	a0,a0,1830 # 66c8 <malloc+0x70a>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     fde:	6ee58593          	add	a1,a1,1774 # 66c8 <malloc+0x70a>
     fe2:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     ff4:	6d850513          	add	a0,a0,1752 # 66c8 <malloc+0x70a>
     ff8:	00005097          	auipc	ra,0x5
     ffc:	be6080e7          	jalr	-1050(ra) # 5bde <unlink>
  if(link("lf2", "lf1") >= 0){
    1000:	00005597          	auipc	a1,0x5
    1004:	6c058593          	add	a1,a1,1728 # 66c0 <malloc+0x702>
    1008:	00005517          	auipc	a0,0x5
    100c:	6c050513          	add	a0,a0,1728 # 66c8 <malloc+0x70a>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1020:	6a458593          	add	a1,a1,1700 # 66c0 <malloc+0x702>
    1024:	00005517          	auipc	a0,0x5
    1028:	7ac50513          	add	a0,a0,1964 # 67d0 <malloc+0x812>
    ...
    104a:	68a50513          	add	a0,a0,1674 # 66d0 <malloc+0x712>
    104e:	00005097          	auipc	ra,0x5
    1052:	eb8080e7          	jalr	-328(ra) # 5f06 <printf>
    exit(1);
    1056:	4505                	li	a0,1
    ...
    1066:	68650513          	add	a0,a0,1670 # 66e8 <malloc+0x72a>
    106a:	00005097          	auipc	ra,0x5
    106e:	e9c080e7          	jalr	-356(ra) # 5f06 <printf>
    exit(1);
    1072:	4505                	li	a0,1
    ...
    1082:	68250513          	add	a0,a0,1666 # 6700 <malloc+0x742>
    1086:	00005097          	auipc	ra,0x5
    108a:	e80080e7          	jalr	-384(ra) # 5f06 <printf>
    exit(1);
    108e:	4505                	li	a0,1
    ...
    109e:	68650513          	add	a0,a0,1670 # 6720 <malloc+0x762>
    10a2:	00005097          	auipc	ra,0x5
    10a6:	e64080e7          	jalr	-412(ra) # 5f06 <printf>
    exit(1);
    10aa:	4505                	li	a0,1
    ...
    10ba:	69a50513          	add	a0,a0,1690 # 6750 <malloc+0x792>
    10be:	00005097          	auipc	ra,0x5
    10c2:	e48080e7          	jalr	-440(ra) # 5f06 <printf>
    exit(1);
    10c6:	4505                	li	a0,1
    ...
    10d6:	69650513          	add	a0,a0,1686 # 6768 <malloc+0x7aa>
    10da:	00005097          	auipc	ra,0x5
    10de:	e2c080e7          	jalr	-468(ra) # 5f06 <printf>
    exit(1);
    10e2:	4505                	li	a0,1
    ...
    10f2:	69250513          	add	a0,a0,1682 # 6780 <malloc+0x7c2>
    10f6:	00005097          	auipc	ra,0x5
    10fa:	e10080e7          	jalr	-496(ra) # 5f06 <printf>
    exit(1);
    10fe:	4505                	li	a0,1
    ...
    110e:	69e50513          	add	a0,a0,1694 # 67a8 <malloc+0x7ea>
    1112:	00005097          	auipc	ra,0x5
    1116:	df4080e7          	jalr	-524(ra) # 5f06 <printf>
    exit(1);
    111a:	4505                	li	a0,1
    ...
    112a:	6b250513          	add	a0,a0,1714 # 67d8 <malloc+0x81a>
    112e:	00005097          	auipc	ra,0x5
    1132:	dd8080e7          	jalr	-552(ra) # 5f06 <printf>
    exit(1);
    1136:	4505                	li	a0,1
...
0000000000001140 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    115c:	6a098993          	add	s3,s3,1696 # 67f8 <malloc+0x83a>
    1160:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    1198:	67450513          	add	a0,a0,1652 # 6808 <malloc+0x84a>
    119c:	00005097          	auipc	ra,0x5
    11a0:	d6a080e7          	jalr	-662(ra) # 5f06 <printf>
      exit(1);
    11a4:	4505                	li	a0,1
...
00000000000011ae <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    11fe:	62ea0a13          	add	s4,s4,1582 # 6828 <malloc+0x86a>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1250:	5dc50513          	add	a0,a0,1500 # 6828 <malloc+0x86a>
  ...
  for(i = 0; i < N; i++){
    ...
    12c0:	57450513          	add	a0,a0,1396 # 6830 <malloc+0x872>
    12c4:	00005097          	auipc	ra,0x5
    12c8:	c42080e7          	jalr	-958(ra) # 5f06 <printf>
    exit(1);
    12cc:	4505                	li	a0,1
    ...
    12e0:	57450513          	add	a0,a0,1396 # 6850 <malloc+0x892>
    12e4:	00005097          	auipc	ra,0x5
    12e8:	c22080e7          	jalr	-990(ra) # 5f06 <printf>
      exit(1);
    12ec:	4505                	li	a0,1
    ...
    12fc:	57850513          	add	a0,a0,1400 # 6870 <malloc+0x8b2>
    1300:	00005097          	auipc	ra,0x5
    1304:	c06080e7          	jalr	-1018(ra) # 5f06 <printf>
      exit(1);
    1308:	4505                	li	a0,1
...
000000000000134a <badarg>:
{
    ...
    1368:	d8498993          	add	s3,s3,-636 # 60e8 <malloc+0x12a>
    argv[0] = (char*)0xffffffff;
...
0000000000001390 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    13f2:	6da78793          	add	a5,a5,1754 # 7ac8 <malloc+0x1b0a>
  ...
  if(pid == 0){
    ...
    144e:	0be78793          	add	a5,a5,190 # 8508 <malloc+0x254a>
    ...
    1472:	c7a50513          	add	a0,a0,-902 # 60e8 <malloc+0x12a>
    ...
    148a:	49250513          	add	a0,a0,1170 # 6918 <malloc+0x95a>
    148e:	00005097          	auipc	ra,0x5
    1492:	a78080e7          	jalr	-1416(ra) # 5f06 <printf>
      exit(1);
    1496:	4505                	li	a0,1
    ...
    14aa:	3ea50513          	add	a0,a0,1002 # 6890 <malloc+0x8d2>
    14ae:	00005097          	auipc	ra,0x5
    14b2:	a58080e7          	jalr	-1448(ra) # 5f06 <printf>
    exit(1);
    14b6:	4505                	li	a0,1
    ...
    14ca:	3ea50513          	add	a0,a0,1002 # 68b0 <malloc+0x8f2>
    14ce:	00005097          	auipc	ra,0x5
    14d2:	a38080e7          	jalr	-1480(ra) # 5f06 <printf>
    exit(1);
    14d6:	4505                	li	a0,1
    ...
    14ec:	3e850513          	add	a0,a0,1000 # 68d0 <malloc+0x912>
    14f0:	00005097          	auipc	ra,0x5
    14f4:	a16080e7          	jalr	-1514(ra) # 5f06 <printf>
    exit(1);
    14f8:	4505                	li	a0,1
    ...
    150c:	3f050513          	add	a0,a0,1008 # 68f8 <malloc+0x93a>
    1510:	00005097          	auipc	ra,0x5
    1514:	9f6080e7          	jalr	-1546(ra) # 5f06 <printf>
    exit(1);
    1518:	4505                	li	a0,1
    ...
    1526:	85650513          	add	a0,a0,-1962 # 6d78 <malloc+0xdba>
    152a:	00005097          	auipc	ra,0x5
    152e:	9dc080e7          	jalr	-1572(ra) # 5f06 <printf>
    exit(1);
    1532:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1570:	3d450513          	add	a0,a0,980 # 6940 <malloc+0x982>
    1574:	00005097          	auipc	ra,0x5
    1578:	992080e7          	jalr	-1646(ra) # 5f06 <printf>
    exit(1);
    157c:	4505                	li	a0,1
...
0000000000001586 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    15a2:	ba250513          	add	a0,a0,-1118 # 6140 <malloc+0x182>
  ...
  if(pid == 0){
    ...
    15cc:	b78a0a13          	add	s4,s4,-1160 # 6140 <malloc+0x182>
      int n = write(fd, "1234567890", 10);
    15d0:	00005a97          	auipc	s5,0x5
    15d4:	3d0a8a93          	add	s5,s5,976 # 69a0 <malloc+0x9e2>
      int fd = open("truncfile", O_WRONLY);
    15d8:	4585                	li	a1,1
    15da:	8552                	mv	a0,s4
    ...
    1644:	33050513          	add	a0,a0,816 # 6970 <malloc+0x9b2>
    1648:	00005097          	auipc	ra,0x5
    164c:	8be080e7          	jalr	-1858(ra) # 5f06 <printf>
    exit(1);
    1650:	4505                	li	a0,1
    ...
    1660:	32c50513          	add	a0,a0,812 # 6988 <malloc+0x9ca>
    1664:	00005097          	auipc	ra,0x5
    1668:	8a2080e7          	jalr	-1886(ra) # 5f06 <printf>
        exit(1);
    166c:	4505                	li	a0,1
    ...
    167e:	33650513          	add	a0,a0,822 # 69b0 <malloc+0x9f2>
    1682:	00005097          	auipc	ra,0x5
    1686:	884080e7          	jalr	-1916(ra) # 5f06 <printf>
        exit(1);
    168a:	4505                	li	a0,1
    ...
    169c:	aa8a0a13          	add	s4,s4,-1368 # 6140 <malloc+0x182>
    int n = write(fd, "xxx", 3);
    16a0:	00005a97          	auipc	s5,0x5
    16a4:	330a8a93          	add	s5,s5,816 # 69d0 <malloc+0xa12>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    16ee:	a5650513          	add	a0,a0,-1450 # 6140 <malloc+0x182>
  ...
  exit(xstatus);
    ...
    170c:	28050513          	add	a0,a0,640 # 6988 <malloc+0x9ca>
    1710:	00004097          	auipc	ra,0x4
    1714:	7f6080e7          	jalr	2038(ra) # 5f06 <printf>
      exit(1);
    1718:	4505                	li	a0,1
    ...
    172a:	2b250513          	add	a0,a0,690 # 69d8 <malloc+0xa1a>
    172e:	00004097          	auipc	ra,0x4
    1732:	7d8080e7          	jalr	2008(ra) # 5f06 <printf>
      exit(1);
    1736:	4505                	li	a0,1
...
0000000000001740 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1752:	99a78793          	add	a5,a5,-1638 # 60e8 <malloc+0x12a>
    1756:	fcf43023          	sd	a5,-64(s0)
    175a:	00005797          	auipc	a5,0x5
    175e:	29e78793          	add	a5,a5,670 # 69f8 <malloc+0xa3a>
    1762:	fcf43423          	sd	a5,-56(s0)
    1766:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    176a:	00005517          	auipc	a0,0x5
    176e:	29650513          	add	a0,a0,662 # 6a00 <malloc+0xa42>
  ...
  if(pid == 0) {
    ...
    179c:	26850513          	add	a0,a0,616 # 6a00 <malloc+0xa42>
    ...
    17b8:	26c50513          	add	a0,a0,620 # 6a20 <malloc+0xa62>
    17bc:	00004097          	auipc	ra,0x4
    17c0:	74a080e7          	jalr	1866(ra) # 5f06 <printf>
      exit(1);
    17c4:	4505                	li	a0,1
    ...
    17d4:	1a050513          	add	a0,a0,416 # 6970 <malloc+0x9b2>
    17d8:	00004097          	auipc	ra,0x4
    17dc:	72e080e7          	jalr	1838(ra) # 5f06 <printf>
     exit(1);
    17e0:	4505                	li	a0,1
    ...
    17f0:	21c50513          	add	a0,a0,540 # 6a08 <malloc+0xa4a>
    17f4:	00004097          	auipc	ra,0x4
    17f8:	712080e7          	jalr	1810(ra) # 5f06 <printf>
      exit(1);
    17fc:	4505                	li	a0,1
    ...
    180e:	8de50513          	add	a0,a0,-1826 # 60e8 <malloc+0x12a>
  ...
  if(xstatus != 0)
    ...
    1842:	1f250513          	add	a0,a0,498 # 6a30 <malloc+0xa72>
    1846:	00004097          	auipc	ra,0x4
    184a:	6c0080e7          	jalr	1728(ra) # 5f06 <printf>
      exit(1);
    184e:	4505                	li	a0,1
    ...
    185e:	1ee50513          	add	a0,a0,494 # 6a48 <malloc+0xa8a>
    1862:	00004097          	auipc	ra,0x4
    1866:	6a4080e7          	jalr	1700(ra) # 5f06 <printf>
    186a:	b7d1                	j	182e <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    186c:	4581                	li	a1,0
    186e:	00005517          	auipc	a0,0x5
    1872:	19250513          	add	a0,a0,402 # 6a00 <malloc+0xa42>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    189c:	c2050513          	add	a0,a0,-992 # 64b8 <malloc+0x4fa>
    18a0:	00004097          	auipc	ra,0x4
    18a4:	666080e7          	jalr	1638(ra) # 5f06 <printf>
    exit(1);
    18a8:	4505                	li	a0,1
    ...
    18b8:	0d450513          	add	a0,a0,212 # 6988 <malloc+0x9ca>
    18bc:	00004097          	auipc	ra,0x4
    18c0:	64a080e7          	jalr	1610(ra) # 5f06 <printf>
    exit(1);
    18c4:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    18d2:	13250513          	add	a0,a0,306 # 6a00 <malloc+0xa42>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    18fc:	16850513          	add	a0,a0,360 # 6a60 <malloc+0xaa2>
    1900:	00004097          	auipc	ra,0x4
    1904:	606080e7          	jalr	1542(ra) # 5f06 <printf>
    exit(1);
    1908:	4505                	li	a0,1
...
000000000000191c <pipe1>:
{
  ...
  if(pid == 0){
    ...
    19bc:	0c050513          	add	a0,a0,192 # 6a78 <malloc+0xaba>
    19c0:	00004097          	auipc	ra,0x4
    19c4:	546080e7          	jalr	1350(ra) # 5f06 <printf>
    exit(1);
    19c8:	4505                	li	a0,1
    ...
    19f6:	42da8a93          	add	s5,s5,1069 # 142d <copyinstr2+0x9d>
{
    ...
    1a42:	05250513          	add	a0,a0,82 # 6a90 <malloc+0xad2>
    1a46:	00004097          	auipc	ra,0x4
    1a4a:	4c0080e7          	jalr	1216(ra) # 5f06 <printf>
        exit(1);
    1a4e:	4505                	li	a0,1
    ...
    1a5e:	04e50513          	add	a0,a0,78 # 6aa8 <malloc+0xaea>
    1a62:	00004097          	auipc	ra,0x4
    1a66:	4a4080e7          	jalr	1188(ra) # 5f06 <printf>
}
    ...
    1a90:	03450513          	add	a0,a0,52 # 6ac0 <malloc+0xb02>
    1a94:	00004097          	auipc	ra,0x4
    1a98:	472080e7          	jalr	1138(ra) # 5f06 <printf>
      exit(1);
    1a9c:	4505                	li	a0,1
    ...
    1ad0:	01450513          	add	a0,a0,20 # 6ae0 <malloc+0xb22>
    1ad4:	00004097          	auipc	ra,0x4
    1ad8:	432080e7          	jalr	1074(ra) # 5f06 <printf>
    exit(1);
    1adc:	4505                	li	a0,1
...
0000000000001ae6 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b42:	e3250513          	add	a0,a0,-462 # 6970 <malloc+0x9b2>
    1b46:	00004097          	auipc	ra,0x4
    1b4a:	3c0080e7          	jalr	960(ra) # 5f06 <printf>
      exit(1);
    1b4e:	4505                	li	a0,1
    ...
    1b5e:	f9e50513          	add	a0,a0,-98 # 6af8 <malloc+0xb3a>
    1b62:	00004097          	auipc	ra,0x4
    1b66:	3a4080e7          	jalr	932(ra) # 5f06 <printf>
        exit(1);
    1b6a:	4505                	li	a0,1
    ...
    1b7a:	f9a50513          	add	a0,a0,-102 # 6b10 <malloc+0xb52>
    1b7e:	00004097          	auipc	ra,0x4
    1b82:	388080e7          	jalr	904(ra) # 5f06 <printf>
        exit(1);
    1b86:	4505                	li	a0,1
...
0000000000001b9a <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1bf2:	d8250513          	add	a0,a0,-638 # 6970 <malloc+0x9b2>
    1bf6:	00004097          	auipc	ra,0x4
    1bfa:	310080e7          	jalr	784(ra) # 5f06 <printf>
      exit(1);
    1bfe:	4505                	li	a0,1
    ...
    1c16:	d5e50513          	add	a0,a0,-674 # 6970 <malloc+0x9b2>
    1c1a:	00004097          	auipc	ra,0x4
    1c1e:	2ec080e7          	jalr	748(ra) # 5f06 <printf>
        exit(1);
    1c22:	4505                	li	a0,1
...
0000000000001c34 <forkfork>:
{
    ...
    1c90:	ea450513          	add	a0,a0,-348 # 6b30 <malloc+0xb72>
    1c94:	00004097          	auipc	ra,0x4
    1c98:	272080e7          	jalr	626(ra) # 5f06 <printf>
      exit(1);
    1c9c:	4505                	li	a0,1
    ...
    1ca2:	ef0080e7          	jalr	-272(ra) # 5b8e <exit>
{
    ...
    1ce8:	e5c50513          	add	a0,a0,-420 # 6b40 <malloc+0xb82>
    1cec:	00004097          	auipc	ra,0x4
    1cf0:	21a080e7          	jalr	538(ra) # 5f06 <printf>
      exit(1);
    1cf4:	4505                	li	a0,1
...
0000000000001cfe <reparent2>:
{
  ...
  exit(0);
    ...
    1d36:	04650513          	add	a0,a0,70 # 6d78 <malloc+0xdba>
    1d3a:	00004097          	auipc	ra,0x4
    1d3e:	1cc080e7          	jalr	460(ra) # 5f06 <printf>
      exit(1);
    1d42:	4505                	li	a0,1
...
0000000000001d66 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1dd4:	fa850513          	add	a0,a0,-88 # 6d78 <malloc+0xdba>
    1dd8:	00004097          	auipc	ra,0x4
    1ddc:	12e080e7          	jalr	302(ra) # 5f06 <printf>
      exit(1);
    1de0:	4505                	li	a0,1
    ...
    1e00:	c0c50513          	add	a0,a0,-1012 # 6a08 <malloc+0xa4a>
    1e04:	00004097          	auipc	ra,0x4
    1e08:	102080e7          	jalr	258(ra) # 5f06 <printf>
          exit(1);
    1e0c:	4505                	li	a0,1
    ...
    1e72:	cf250513          	add	a0,a0,-782 # 6b60 <malloc+0xba2>
    1e76:	00004097          	auipc	ra,0x4
    1e7a:	090080e7          	jalr	144(ra) # 5f06 <printf>
            exit(1);
    1e7e:	4505                	li	a0,1
    ...
    1ea6:	cd650513          	add	a0,a0,-810 # 6b78 <malloc+0xbba>
    1eaa:	00004097          	auipc	ra,0x4
    1eae:	05c080e7          	jalr	92(ra) # 5f06 <printf>
        exit(1);
    1eb2:	4505                	li	a0,1
    ...
    1f0c:	c9850513          	add	a0,a0,-872 # 6ba0 <malloc+0xbe2>
    1f10:	00004097          	auipc	ra,0x4
    1f14:	ff6080e7          	jalr	-10(ra) # 5f06 <printf>
        exit(1);
    1f18:	4505                	li	a0,1
...
0000000000001f8c <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fac:	1b050513          	add	a0,a0,432 # 6158 <malloc+0x19a>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1fe8:	174a8a93          	add	s5,s5,372 # 6158 <malloc+0x19a>
      link("cat", "x");
    1fec:	00005b97          	auipc	s7,0x5
    1ff0:	bdcb8b93          	add	s7,s7,-1060 # 6bc8 <malloc+0xc0a>
    1ff4:	a825                	j	202c <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1ff6:	85a6                	mv	a1,s1
    1ff8:	00005517          	auipc	a0,0x5
    1ffc:	97850513          	add	a0,a0,-1672 # 6970 <malloc+0x9b2>
    2000:	00004097          	auipc	ra,0x4
    2004:	f06080e7          	jalr	-250(ra) # 5f06 <printf>
    exit(1);
    2008:	4505                	li	a0,1
...
000000000000208e <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20be:	b2e50513          	add	a0,a0,-1234 # 6be8 <malloc+0xc2a>
    20c2:	00004097          	auipc	ra,0x4
    20c6:	e44080e7          	jalr	-444(ra) # 5f06 <printf>
    exit(1);
    20ca:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    2120:	ab450513          	add	a0,a0,-1356 # 6bd0 <malloc+0xc12>
    2124:	00004097          	auipc	ra,0x4
    2128:	de2080e7          	jalr	-542(ra) # 5f06 <printf>
    exit(1);
    212c:	4505                	li	a0,1
    ...
    213c:	ad850513          	add	a0,a0,-1320 # 6c10 <malloc+0xc52>
    2140:	00004097          	auipc	ra,0x4
    2144:	dc6080e7          	jalr	-570(ra) # 5f06 <printf>
      exit(1);
    2148:	4505                	li	a0,1
    ...
    2158:	ad450513          	add	a0,a0,-1324 # 6c28 <malloc+0xc6a>
    215c:	00004097          	auipc	ra,0x4
    2160:	daa080e7          	jalr	-598(ra) # 5f06 <printf>
    exit(1);
    2164:	4505                	li	a0,1
...
000000000000216e <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21d8:	79c50513          	add	a0,a0,1948 # 6970 <malloc+0x9b2>
    21dc:	00004097          	auipc	ra,0x4
    21e0:	d2a080e7          	jalr	-726(ra) # 5f06 <printf>
      exit(1);
    21e4:	4505                	li	a0,1
    ...
    21fa:	a4a50513          	add	a0,a0,-1462 # 6c40 <malloc+0xc82>
    21fe:	00004097          	auipc	ra,0x4
    2202:	d08080e7          	jalr	-760(ra) # 5f06 <printf>
      exit(1);
    2206:	4505                	li	a0,1
...
000000000000221a <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    227c:	6f850513          	add	a0,a0,1784 # 6970 <malloc+0x9b2>
    2280:	00004097          	auipc	ra,0x4
    2284:	c86080e7          	jalr	-890(ra) # 5f06 <printf>
      exit(1);
    2288:	4505                	li	a0,1
    ...
    22a8:	9bc50513          	add	a0,a0,-1604 # 6c60 <malloc+0xca2>
    22ac:	00004097          	auipc	ra,0x4
    22b0:	c5a080e7          	jalr	-934(ra) # 5f06 <printf>
      exit(1);
    22b4:	4505                	li	a0,1
...
00000000000022c8 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    22d8:	9a450513          	add	a0,a0,-1628 # 6c78 <malloc+0xcba>
  ...
  fd = open("bigarg-ok", 0);
    ...
    230a:	97250513          	add	a0,a0,-1678 # 6c78 <malloc+0xcba>
  ...
  close(fd);
    ...
    2340:	94c70713          	add	a4,a4,-1716 # 6c88 <malloc+0xcca>
    ...
    2394:	9d850513          	add	a0,a0,-1576 # 6d68 <malloc+0xdaa>
    2398:	00004097          	auipc	ra,0x4
    239c:	b6e080e7          	jalr	-1170(ra) # 5f06 <printf>
    exit(1);
    23a0:	4505                	li	a0,1
    ...
    23b8:	9d450513          	add	a0,a0,-1580 # 6d88 <malloc+0xdca>
    23bc:	00004097          	auipc	ra,0x4
    23c0:	b4a080e7          	jalr	-1206(ra) # 5f06 <printf>
    exit(1);
    23c4:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2416:	99650513          	add	a0,a0,-1642 # 6da8 <malloc+0xdea>
    241a:	00004097          	auipc	ra,0x4
    241e:	aec080e7          	jalr	-1300(ra) # 5f06 <printf>
    exit(1);
    2422:	4505                	li	a0,1
    ...
    2432:	54250513          	add	a0,a0,1346 # 6970 <malloc+0x9b2>
    2436:	00004097          	auipc	ra,0x4
    243a:	ad0080e7          	jalr	-1328(ra) # 5f06 <printf>
    exit(1);
    243e:	4505                	li	a0,1
...
0000000000002452 <textwrite>:
{
  ...
  if(xstatus == -1)  // kernel killed child?
    ...
    *addr = 10;
    ...
    24a0:	4d450513          	add	a0,a0,1236 # 6970 <malloc+0x9b2>
    24a4:	00004097          	auipc	ra,0x4
    24a8:	a62080e7          	jalr	-1438(ra) # 5f06 <printf>
    exit(1);
    24ac:	4505                	li	a0,1
...
00000000000024c0 <manywrites>:
{
  ...
  exit(0);
    ...
    251c:	86050513          	add	a0,a0,-1952 # 6d78 <malloc+0xdba>
    2520:	00004097          	auipc	ra,0x4
    2524:	9e6080e7          	jalr	-1562(ra) # 5f06 <printf>
      exit(1);
    2528:	4505                	li	a0,1
    ...
    25cc:	80850513          	add	a0,a0,-2040 # 6dd0 <malloc+0xe12>
    25d0:	00004097          	auipc	ra,0x4
    25d4:	936080e7          	jalr	-1738(ra) # 5f06 <printf>
            exit(1);
    25d8:	4505                	li	a0,1
    ...
    25ec:	bd050513          	add	a0,a0,-1072 # 61b8 <malloc+0x1fa>
    25f0:	00004097          	auipc	ra,0x4
    25f4:	916080e7          	jalr	-1770(ra) # 5f06 <printf>
            exit(1);
    25f8:	4505                	li	a0,1
...
000000000000260a <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2684:	44878793          	add	a5,a5,1096 # 7ac8 <malloc+0x1b0a>
  ...
  if(ret != -1){
    ...
    26c6:	72650513          	add	a0,a0,1830 # 6de8 <malloc+0xe2a>
    26ca:	00004097          	auipc	ra,0x4
    26ce:	83c080e7          	jalr	-1988(ra) # 5f06 <printf>
    exit(1);
    26d2:	4505                	li	a0,1
    ...
    26e4:	1b050513          	add	a0,a0,432 # 6890 <malloc+0x8d2>
    26e8:	00004097          	auipc	ra,0x4
    26ec:	81e080e7          	jalr	-2018(ra) # 5f06 <printf>
    exit(1);
    26f0:	4505                	li	a0,1
    ...
    2702:	1b250513          	add	a0,a0,434 # 68b0 <malloc+0x8f2>
    2706:	00004097          	auipc	ra,0x4
    270a:	800080e7          	jalr	-2048(ra) # 5f06 <printf>
    exit(1);
    270e:	4505                	li	a0,1
    ...
    2722:	1b250513          	add	a0,a0,434 # 68d0 <malloc+0x912>
    2726:	00003097          	auipc	ra,0x3
    272a:	7e0080e7          	jalr	2016(ra) # 5f06 <printf>
    exit(1);
    272e:	4505                	li	a0,1
    ...
    2740:	1bc50513          	add	a0,a0,444 # 68f8 <malloc+0x93a>
    2744:	00003097          	auipc	ra,0x3
    2748:	7c2080e7          	jalr	1986(ra) # 5f06 <printf>
    exit(1);
    274c:	4505                	li	a0,1
...
0000000000002756 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    278c:	6a050513          	add	a0,a0,1696 # 6e28 <malloc+0xe6a>
  ...
  if(n >= 0){
    ...
    27bc:	69050513          	add	a0,a0,1680 # 6e48 <malloc+0xe8a>
    27c0:	00003097          	auipc	ra,0x3
    27c4:	746080e7          	jalr	1862(ra) # 5f06 <printf>
    exit(1);
    27c8:	4505                	li	a0,1
    ...
    27d6:	61e50513          	add	a0,a0,1566 # 6df0 <malloc+0xe32>
    27da:	00003097          	auipc	ra,0x3
    27de:	72c080e7          	jalr	1836(ra) # 5f06 <printf>
    exit(1);
    27e2:	4505                	li	a0,1
    ...
    27f0:	61c50513          	add	a0,a0,1564 # 6e08 <malloc+0xe4a>
    27f4:	00003097          	auipc	ra,0x3
    27f8:	712080e7          	jalr	1810(ra) # 5f06 <printf>
    exit(1);
    27fc:	4505                	li	a0,1
    ...
    280a:	62a50513          	add	a0,a0,1578 # 6e30 <malloc+0xe72>
    280e:	00003097          	auipc	ra,0x3
    2812:	6f8080e7          	jalr	1784(ra) # 5f06 <printf>
    exit(1);
    2816:	4505                	li	a0,1
  ...
  if(n >= 0){
    ...
    286a:	61250513          	add	a0,a0,1554 # 6e78 <malloc+0xeba>
    286e:	00003097          	auipc	ra,0x3
    2872:	698080e7          	jalr	1688(ra) # 5f06 <printf>
    exit(1);
    2876:	4505                	li	a0,1
    ...
    2884:	5b050513          	add	a0,a0,1456 # 6e30 <malloc+0xe72>
    2888:	00003097          	auipc	ra,0x3
    288c:	67e080e7          	jalr	1662(ra) # 5f06 <printf>
    exit(1);
    2890:	4505                	li	a0,1
...
00000000000028ae <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2904:	5a050513          	add	a0,a0,1440 # 6ea0 <malloc+0xee2>
    2908:	00003097          	auipc	ra,0x3
    290c:	5fe080e7          	jalr	1534(ra) # 5f06 <printf>
    exit(1);
    2910:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2956:	56e50513          	add	a0,a0,1390 # 6ec0 <malloc+0xf02>
    295a:	00003097          	auipc	ra,0x3
    295e:	5ac080e7          	jalr	1452(ra) # 5f06 <printf>
    exit(1);
    2962:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    29ba:	56a50513          	add	a0,a0,1386 # 6f20 <malloc+0xf62>
    29be:	00003097          	auipc	ra,0x3
    29c2:	548080e7          	jalr	1352(ra) # 5f06 <printf>
    exit(1);
    29c6:	4505                	li	a0,1
    ...
    29dc:	50850513          	add	a0,a0,1288 # 6ee0 <malloc+0xf22>
    29e0:	00003097          	auipc	ra,0x3
    29e4:	526080e7          	jalr	1318(ra) # 5f06 <printf>
      exit(1);
    29e8:	4505                	li	a0,1
    ...
    29f8:	50c50513          	add	a0,a0,1292 # 6f00 <malloc+0xf42>
    29fc:	00003097          	auipc	ra,0x3
    2a00:	50a080e7          	jalr	1290(ra) # 5f06 <printf>
    exit(1);
    2a04:	4505                	li	a0,1
...
0000000000002a34 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    2b42:	40250513          	add	a0,a0,1026 # 6f40 <malloc+0xf82>
    2b46:	00003097          	auipc	ra,0x3
    2b4a:	3c0080e7          	jalr	960(ra) # 5f06 <printf>
    exit(1);
    2b4e:	4505                	li	a0,1
    ...
    2b5e:	42e50513          	add	a0,a0,1070 # 6f88 <malloc+0xfca>
    2b62:	00003097          	auipc	ra,0x3
    2b66:	3a4080e7          	jalr	932(ra) # 5f06 <printf>
    exit(1);
    2b6a:	4505                	li	a0,1
    ...
    2b7e:	42e50513          	add	a0,a0,1070 # 6fa8 <malloc+0xfea>
    2b82:	00003097          	auipc	ra,0x3
    2b86:	384080e7          	jalr	900(ra) # 5f06 <printf>
    exit(1);
    2b8a:	4505                	li	a0,1
    ...
    2b9e:	44e50513          	add	a0,a0,1102 # 6fe8 <malloc+0x102a>
    2ba2:	00003097          	auipc	ra,0x3
    2ba6:	364080e7          	jalr	868(ra) # 5f06 <printf>
    exit(1);
    2baa:	4505                	li	a0,1
    ...
    2bba:	46250513          	add	a0,a0,1122 # 7018 <malloc+0x105a>
    2bbe:	00003097          	auipc	ra,0x3
    2bc2:	348080e7          	jalr	840(ra) # 5f06 <printf>
    exit(1);
    2bc6:	4505                	li	a0,1
    ...
    2bda:	47a50513          	add	a0,a0,1146 # 7050 <malloc+0x1092>
    2bde:	00003097          	auipc	ra,0x3
    2be2:	328080e7          	jalr	808(ra) # 5f06 <printf>
    exit(1);
    2be6:	4505                	li	a0,1
...
0000000000002bf0 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2c14:	46850513          	add	a0,a0,1128 # 7078 <malloc+0x10ba>
    2c18:	00003097          	auipc	ra,0x3
    2c1c:	fb6080e7          	jalr	-74(ra) # 5bce <open>
    2c20:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c22:	00004517          	auipc	a0,0x4
    2c26:	45650513          	add	a0,a0,1110 # 7078 <malloc+0x10ba>
  ...
  if(pipe((int *) a) != 0){
    ...
    2c7a:	40a50513          	add	a0,a0,1034 # 7080 <malloc+0x10c2>
    2c7e:	00003097          	auipc	ra,0x3
    2c82:	288080e7          	jalr	648(ra) # 5f06 <printf>
    exit(1);
    2c86:	4505                	li	a0,1
    ...
    2c96:	40650513          	add	a0,a0,1030 # 7098 <malloc+0x10da>
    2c9a:	00003097          	auipc	ra,0x3
    2c9e:	26c080e7          	jalr	620(ra) # 5f06 <printf>
    exit(1);
    2ca2:	4505                	li	a0,1
    ...
    2cb2:	dca50513          	add	a0,a0,-566 # 6a78 <malloc+0xaba>
    2cb6:	00003097          	auipc	ra,0x3
    2cba:	250080e7          	jalr	592(ra) # 5f06 <printf>
    exit(1);
    2cbe:	4505                	li	a0,1
...
0000000000002cc8 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2cdc:	3d850513          	add	a0,a0,984 # 70b0 <malloc+0x10f2>
  ...
  close(fd);
    ...
    2d24:	c6850513          	add	a0,a0,-920 # 6988 <malloc+0x9ca>
    2d28:	00003097          	auipc	ra,0x3
    2d2c:	1de080e7          	jalr	478(ra) # 5f06 <printf>
    exit(1);
    2d30:	4505                	li	a0,1
...
0000000000002d3a <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2d72:	00a50513          	add	a0,a0,10 # 6d78 <malloc+0xdba>
    2d76:	00003097          	auipc	ra,0x3
    2d7a:	190080e7          	jalr	400(ra) # 5f06 <printf>
    exit(1);
    2d7e:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2dc8:	fb450513          	add	a0,a0,-76 # 6d78 <malloc+0xdba>
    2dcc:	00003097          	auipc	ra,0x3
    2dd0:	13a080e7          	jalr	314(ra) # 5f06 <printf>
    exit(1);
    2dd4:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2e28:	f5450513          	add	a0,a0,-172 # 6d78 <malloc+0xdba>
    2e2c:	00003097          	auipc	ra,0x3
    2e30:	0da080e7          	jalr	218(ra) # 5f06 <printf>
    exit(1);
    2e34:	4505                	li	a0,1
...
0000000000002f5a <execout>:
{
  ...
  exit(0);
    ...
    2f9c:	de050513          	add	a0,a0,-544 # 6d78 <malloc+0xdba>
    2fa0:	00003097          	auipc	ra,0x3
    2fa4:	f66080e7          	jalr	-154(ra) # 5f06 <printf>
      exit(1);
    2fa8:	4505                	li	a0,1
    ...
    2ff0:	0fc50513          	add	a0,a0,252 # 60e8 <malloc+0x12a>
    2ff4:	faa43c23          	sd	a0,-72(s0)
    2ff8:	00003797          	auipc	a5,0x3
    2ffc:	16078793          	add	a5,a5,352 # 6158 <malloc+0x19a>
...
000000000000301e <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    302e:	25e50513          	add	a0,a0,606 # 7288 <malloc+0x12ca>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    3040:	0a450513          	add	a0,a0,164 # 70e0 <malloc+0x1122>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    3056:	0e650513          	add	a0,a0,230 # 7138 <malloc+0x117a>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    3074:	14050513          	add	a0,a0,320 # 71b0 <malloc+0x11f2>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    3090:	19450513          	add	a0,a0,404 # 7220 <malloc+0x1262>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30a2:	1da50513          	add	a0,a0,474 # 7278 <malloc+0x12ba>
  ...
  unlink("12345678901234");
    ...
    3120:	f9c50513          	add	a0,a0,-100 # 70b8 <malloc+0x10fa>
    3124:	00003097          	auipc	ra,0x3
    3128:	de2080e7          	jalr	-542(ra) # 5f06 <printf>
    exit(1);
    312c:	4505                	li	a0,1
    ...
    313c:	fc850513          	add	a0,a0,-56 # 7100 <malloc+0x1142>
    3140:	00003097          	auipc	ra,0x3
    3144:	dc6080e7          	jalr	-570(ra) # 5f06 <printf>
    exit(1);
    3148:	4505                	li	a0,1
    ...
    3158:	01450513          	add	a0,a0,20 # 7168 <malloc+0x11aa>
    315c:	00003097          	auipc	ra,0x3
    3160:	daa080e7          	jalr	-598(ra) # 5f06 <printf>
    exit(1);
    3164:	4505                	li	a0,1
    ...
    3174:	07050513          	add	a0,a0,112 # 71e0 <malloc+0x1222>
    3178:	00003097          	auipc	ra,0x3
    317c:	d8e080e7          	jalr	-626(ra) # 5f06 <printf>
    exit(1);
    3180:	4505                	li	a0,1
    ...
    3190:	0b450513          	add	a0,a0,180 # 7240 <malloc+0x1282>
    3194:	00003097          	auipc	ra,0x3
    3198:	d72080e7          	jalr	-654(ra) # 5f06 <printf>
    exit(1);
    319c:	4505                	li	a0,1
    ...
    31ac:	0f050513          	add	a0,a0,240 # 7298 <malloc+0x12da>
    31b0:	00003097          	auipc	ra,0x3
    31b4:	d56080e7          	jalr	-682(ra) # 5f06 <printf>
    exit(1);
    31b8:	4505                	li	a0,1
...
00000000000031c2 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    31f8:	0dc50513          	add	a0,a0,220 # 72d0 <malloc+0x1312>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    3222:	0c250513          	add	a0,a0,194 # 72e0 <malloc+0x1322>
    3226:	00003097          	auipc	ra,0x3
    322a:	ce0080e7          	jalr	-800(ra) # 5f06 <printf>
      break;
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    32b2:	02250513          	add	a0,a0,34 # 72d0 <malloc+0x1312>
  ...
  unlink("diskfulldir");
    ...
    32c6:	00e50513          	add	a0,a0,14 # 72d0 <malloc+0x1312>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    33f4:	f1050513          	add	a0,a0,-240 # 7300 <malloc+0x1342>
    33f8:	00003097          	auipc	ra,0x3
    33fc:	b0e080e7          	jalr	-1266(ra) # 5f06 <printf>
...
0000000000003402 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    3412:	f2250513          	add	a0,a0,-222 # 7330 <malloc+0x1372>
  ...
  if(chdir("iputdir") < 0){
    ...
    3426:	f0e50513          	add	a0,a0,-242 # 7330 <malloc+0x1372>
  ...
  if(unlink("../iputdir") < 0){
    ...
    343a:	f3a50513          	add	a0,a0,-198 # 7370 <malloc+0x13b2>
  ...
  if(chdir("/") < 0){
    ...
    344e:	f5650513          	add	a0,a0,-170 # 73a0 <malloc+0x13e2>
    ...
    346e:	ece50513          	add	a0,a0,-306 # 7338 <malloc+0x137a>
    3472:	00003097          	auipc	ra,0x3
    3476:	a94080e7          	jalr	-1388(ra) # 5f06 <printf>
    exit(1);
    347a:	4505                	li	a0,1
    ...
    348a:	eca50513          	add	a0,a0,-310 # 7350 <malloc+0x1392>
    348e:	00003097          	auipc	ra,0x3
    3492:	a78080e7          	jalr	-1416(ra) # 5f06 <printf>
    exit(1);
    3496:	4505                	li	a0,1
    ...
    34a6:	ede50513          	add	a0,a0,-290 # 7380 <malloc+0x13c2>
    34aa:	00003097          	auipc	ra,0x3
    34ae:	a5c080e7          	jalr	-1444(ra) # 5f06 <printf>
    exit(1);
    34b2:	4505                	li	a0,1
    ...
    34c2:	eea50513          	add	a0,a0,-278 # 73a8 <malloc+0x13ea>
    34c6:	00003097          	auipc	ra,0x3
    34ca:	a40080e7          	jalr	-1472(ra) # 5f06 <printf>
    exit(1);
    34ce:	4505                	li	a0,1
...
00000000000034d8 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    34f6:	e3e50513          	add	a0,a0,-450 # 7330 <malloc+0x1372>
    ...
    350a:	e2a50513          	add	a0,a0,-470 # 7330 <malloc+0x1372>
    ...
    351e:	e5650513          	add	a0,a0,-426 # 7370 <malloc+0x13b2>
    ...
    353e:	43650513          	add	a0,a0,1078 # 6970 <malloc+0x9b2>
    3542:	00003097          	auipc	ra,0x3
    3546:	9c4080e7          	jalr	-1596(ra) # 5f06 <printf>
    exit(1);
    354a:	4505                	li	a0,1
    ...
    355a:	de250513          	add	a0,a0,-542 # 7338 <malloc+0x137a>
    355e:	00003097          	auipc	ra,0x3
    3562:	9a8080e7          	jalr	-1624(ra) # 5f06 <printf>
      exit(1);
    3566:	4505                	li	a0,1
    ...
    3576:	e4e50513          	add	a0,a0,-434 # 73c0 <malloc+0x1402>
    357a:	00003097          	auipc	ra,0x3
    357e:	98c080e7          	jalr	-1652(ra) # 5f06 <printf>
      exit(1);
    3582:	4505                	li	a0,1
    ...
    3592:	df250513          	add	a0,a0,-526 # 7380 <malloc+0x13c2>
    3596:	00003097          	auipc	ra,0x3
    359a:	970080e7          	jalr	-1680(ra) # 5f06 <printf>
      exit(1);
    359e:	4505                	li	a0,1
...
00000000000035c0 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    35d0:	e0c50513          	add	a0,a0,-500 # 73d8 <malloc+0x141a>
  ...
  if(chdir("dir0") < 0){
    ...
    35e4:	df850513          	add	a0,a0,-520 # 73d8 <malloc+0x141a>
  ...
  if(chdir("..") < 0){
    ...
    35f8:	e0450513          	add	a0,a0,-508 # 73f8 <malloc+0x143a>
  ...
  if(unlink("dir0") < 0){
    ...
    360c:	dd050513          	add	a0,a0,-560 # 73d8 <malloc+0x141a>
    ...
    362c:	d1050513          	add	a0,a0,-752 # 7338 <malloc+0x137a>
    3630:	00003097          	auipc	ra,0x3
    3634:	8d6080e7          	jalr	-1834(ra) # 5f06 <printf>
    exit(1);
    3638:	4505                	li	a0,1
    ...
    3648:	d9c50513          	add	a0,a0,-612 # 73e0 <malloc+0x1422>
    364c:	00003097          	auipc	ra,0x3
    3650:	8ba080e7          	jalr	-1862(ra) # 5f06 <printf>
    exit(1);
    3654:	4505                	li	a0,1
    ...
    3664:	da050513          	add	a0,a0,-608 # 7400 <malloc+0x1442>
    3668:	00003097          	auipc	ra,0x3
    366c:	89e080e7          	jalr	-1890(ra) # 5f06 <printf>
    exit(1);
    3670:	4505                	li	a0,1
    ...
    3680:	d9c50513          	add	a0,a0,-612 # 7418 <malloc+0x145a>
    3684:	00003097          	auipc	ra,0x3
    3688:	882080e7          	jalr	-1918(ra) # 5f06 <printf>
    exit(1);
    368c:	4505                	li	a0,1
...
0000000000003696 <subdir>:
{
  ...
  unlink("ff");
    ...
    36a8:	ebc50513          	add	a0,a0,-324 # 7560 <malloc+0x15a2>
    36ac:	00002097          	auipc	ra,0x2
    36b0:	532080e7          	jalr	1330(ra) # 5bde <unlink>
  if(mkdir("dd") != 0){
    36b4:	00004517          	auipc	a0,0x4
    36b8:	d7c50513          	add	a0,a0,-644 # 7430 <malloc+0x1472>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    36d0:	d8450513          	add	a0,a0,-636 # 7450 <malloc+0x1492>
  ...
  write(fd, "ff", 2);
    ...
    36e8:	e7c58593          	add	a1,a1,-388 # 7560 <malloc+0x15a2>
  ...
  if(unlink("dd") >= 0){
    ...
    3702:	d3250513          	add	a0,a0,-718 # 7430 <malloc+0x1472>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3716:	d9650513          	add	a0,a0,-618 # 74a8 <malloc+0x14ea>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    372e:	da650513          	add	a0,a0,-602 # 74d0 <malloc+0x1512>
  ...
  write(fd, "FF", 2);
    ...
    3746:	dbe58593          	add	a1,a1,-578 # 7500 <malloc+0x1542>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3762:	daa50513          	add	a0,a0,-598 # 7508 <malloc+0x154a>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    37aa:	db258593          	add	a1,a1,-590 # 7558 <malloc+0x159a>
    37ae:	00004517          	auipc	a0,0x4
    37b2:	d2250513          	add	a0,a0,-734 # 74d0 <malloc+0x1512>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    37c6:	d0e50513          	add	a0,a0,-754 # 74d0 <malloc+0x1512>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    37dc:	cf850513          	add	a0,a0,-776 # 74d0 <malloc+0x1512>
  ...
  if(chdir("dd") != 0){
    ...
    37f0:	c4450513          	add	a0,a0,-956 # 7430 <malloc+0x1472>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3804:	df050513          	add	a0,a0,-528 # 75f0 <malloc+0x1632>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3818:	e0c50513          	add	a0,a0,-500 # 7620 <malloc+0x1662>
  ...
  if(chdir("./..") != 0){
    ...
    382c:	e2850513          	add	a0,a0,-472 # 7650 <malloc+0x1692>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3842:	d1a50513          	add	a0,a0,-742 # 7558 <malloc+0x159a>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    387c:	c5850513          	add	a0,a0,-936 # 74d0 <malloc+0x1512>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3894:	e5050513          	add	a0,a0,-432 # 76e0 <malloc+0x1722>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38ac:	e6850513          	add	a0,a0,-408 # 7710 <malloc+0x1752>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    38c4:	b7050513          	add	a0,a0,-1168 # 7430 <malloc+0x1472>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    38da:	b5a50513          	add	a0,a0,-1190 # 7430 <malloc+0x1472>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    38f0:	b4450513          	add	a0,a0,-1212 # 7430 <malloc+0x1472>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3904:	ea058593          	add	a1,a1,-352 # 77a0 <malloc+0x17e2>
    3908:	00004517          	auipc	a0,0x4
    390c:	dd850513          	add	a0,a0,-552 # 76e0 <malloc+0x1722>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3920:	e8458593          	add	a1,a1,-380 # 77a0 <malloc+0x17e2>
    3924:	00004517          	auipc	a0,0x4
    3928:	dec50513          	add	a0,a0,-532 # 7710 <malloc+0x1752>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    393c:	c2058593          	add	a1,a1,-992 # 7558 <malloc+0x159a>
    3940:	00004517          	auipc	a0,0x4
    3944:	b1050513          	add	a0,a0,-1264 # 7450 <malloc+0x1492>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    3958:	d8c50513          	add	a0,a0,-628 # 76e0 <malloc+0x1722>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    396c:	da850513          	add	a0,a0,-600 # 7710 <malloc+0x1752>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3980:	bdc50513          	add	a0,a0,-1060 # 7558 <malloc+0x159a>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3994:	d8050513          	add	a0,a0,-640 # 7710 <malloc+0x1752>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    39a8:	d3c50513          	add	a0,a0,-708 # 76e0 <malloc+0x1722>
  ...
  if(chdir("dd/ff") == 0){
    ...
    39bc:	a9850513          	add	a0,a0,-1384 # 7450 <malloc+0x1492>
  ...
  if(chdir("dd/xx") == 0){
    ...
    39d0:	f2450513          	add	a0,a0,-220 # 78f0 <malloc+0x1932>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    39e4:	b7850513          	add	a0,a0,-1160 # 7558 <malloc+0x159a>
  ...
  if(unlink("dd/ff") != 0){
    ...
    39f8:	a5c50513          	add	a0,a0,-1444 # 7450 <malloc+0x1492>
  ...
  if(unlink("dd") == 0){
    ...
    3a0c:	a2850513          	add	a0,a0,-1496 # 7430 <malloc+0x1472>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a20:	f4450513          	add	a0,a0,-188 # 7960 <malloc+0x19a2>
  ...
  if(unlink("dd") < 0){
    ...
    3a34:	a0050513          	add	a0,a0,-1536 # 7430 <malloc+0x1472>
    ...
    3a56:	9e650513          	add	a0,a0,-1562 # 7438 <malloc+0x147a>
    3a5a:	00002097          	auipc	ra,0x2
    3a5e:	4ac080e7          	jalr	1196(ra) # 5f06 <printf>
    exit(1);
    3a62:	4505                	li	a0,1
    ...
    3a72:	9ea50513          	add	a0,a0,-1558 # 7458 <malloc+0x149a>
    3a76:	00002097          	auipc	ra,0x2
    3a7a:	490080e7          	jalr	1168(ra) # 5f06 <printf>
    exit(1);
    3a7e:	4505                	li	a0,1
    ...
    3a8e:	9ee50513          	add	a0,a0,-1554 # 7478 <malloc+0x14ba>
    3a92:	00002097          	auipc	ra,0x2
    3a96:	474080e7          	jalr	1140(ra) # 5f06 <printf>
    exit(1);
    3a9a:	4505                	li	a0,1
    ...
    3aaa:	a0a50513          	add	a0,a0,-1526 # 74b0 <malloc+0x14f2>
    3aae:	00002097          	auipc	ra,0x2
    3ab2:	458080e7          	jalr	1112(ra) # 5f06 <printf>
    exit(1);
    3ab6:	4505                	li	a0,1
    ...
    3ac6:	a1e50513          	add	a0,a0,-1506 # 74e0 <malloc+0x1522>
    3aca:	00002097          	auipc	ra,0x2
    3ace:	43c080e7          	jalr	1084(ra) # 5f06 <printf>
    exit(1);
    3ad2:	4505                	li	a0,1
    ...
    3ae2:	a3a50513          	add	a0,a0,-1478 # 7518 <malloc+0x155a>
    3ae6:	00002097          	auipc	ra,0x2
    3aea:	420080e7          	jalr	1056(ra) # 5f06 <printf>
    exit(1);
    3aee:	4505                	li	a0,1
    ...
    3afe:	a3e50513          	add	a0,a0,-1474 # 7538 <malloc+0x157a>
    3b02:	00002097          	auipc	ra,0x2
    3b06:	404080e7          	jalr	1028(ra) # 5f06 <printf>
    exit(1);
    3b0a:	4505                	li	a0,1
    ...
    3b1a:	a5250513          	add	a0,a0,-1454 # 7568 <malloc+0x15aa>
    3b1e:	00002097          	auipc	ra,0x2
    3b22:	3e8080e7          	jalr	1000(ra) # 5f06 <printf>
    exit(1);
    3b26:	4505                	li	a0,1
    ...
    3b36:	a5e50513          	add	a0,a0,-1442 # 7590 <malloc+0x15d2>
    3b3a:	00002097          	auipc	ra,0x2
    3b3e:	3cc080e7          	jalr	972(ra) # 5f06 <printf>
    exit(1);
    3b42:	4505                	li	a0,1
    ...
    3b52:	a6250513          	add	a0,a0,-1438 # 75b0 <malloc+0x15f2>
    3b56:	00002097          	auipc	ra,0x2
    3b5a:	3b0080e7          	jalr	944(ra) # 5f06 <printf>
    exit(1);
    3b5e:	4505                	li	a0,1
    ...
    3b6e:	a6e50513          	add	a0,a0,-1426 # 75d8 <malloc+0x161a>
    3b72:	00002097          	auipc	ra,0x2
    3b76:	394080e7          	jalr	916(ra) # 5f06 <printf>
    exit(1);
    3b7a:	4505                	li	a0,1
    ...
    3b8a:	a7a50513          	add	a0,a0,-1414 # 7600 <malloc+0x1642>
    3b8e:	00002097          	auipc	ra,0x2
    3b92:	378080e7          	jalr	888(ra) # 5f06 <printf>
    exit(1);
    3b96:	4505                	li	a0,1
    ...
    3ba6:	a8e50513          	add	a0,a0,-1394 # 7630 <malloc+0x1672>
    3baa:	00002097          	auipc	ra,0x2
    3bae:	35c080e7          	jalr	860(ra) # 5f06 <printf>
    exit(1);
    3bb2:	4505                	li	a0,1
    ...
    3bc2:	a9a50513          	add	a0,a0,-1382 # 7658 <malloc+0x169a>
    3bc6:	00002097          	auipc	ra,0x2
    3bca:	340080e7          	jalr	832(ra) # 5f06 <printf>
    exit(1);
    3bce:	4505                	li	a0,1
    ...
    3bde:	a9650513          	add	a0,a0,-1386 # 7670 <malloc+0x16b2>
    3be2:	00002097          	auipc	ra,0x2
    3be6:	324080e7          	jalr	804(ra) # 5f06 <printf>
    exit(1);
    3bea:	4505                	li	a0,1
    ...
    3bfa:	a9a50513          	add	a0,a0,-1382 # 7690 <malloc+0x16d2>
    3bfe:	00002097          	auipc	ra,0x2
    3c02:	308080e7          	jalr	776(ra) # 5f06 <printf>
    exit(1);
    3c06:	4505                	li	a0,1
    ...
    3c16:	a9e50513          	add	a0,a0,-1378 # 76b0 <malloc+0x16f2>
    3c1a:	00002097          	auipc	ra,0x2
    3c1e:	2ec080e7          	jalr	748(ra) # 5f06 <printf>
    exit(1);
    3c22:	4505                	li	a0,1
    ...
    3c32:	ac250513          	add	a0,a0,-1342 # 76f0 <malloc+0x1732>
    3c36:	00002097          	auipc	ra,0x2
    3c3a:	2d0080e7          	jalr	720(ra) # 5f06 <printf>
    exit(1);
    3c3e:	4505                	li	a0,1
    ...
    3c4e:	ad650513          	add	a0,a0,-1322 # 7720 <malloc+0x1762>
    3c52:	00002097          	auipc	ra,0x2
    3c56:	2b4080e7          	jalr	692(ra) # 5f06 <printf>
    exit(1);
    3c5a:	4505                	li	a0,1
    ...
    3c6a:	ada50513          	add	a0,a0,-1318 # 7740 <malloc+0x1782>
    3c6e:	00002097          	auipc	ra,0x2
    3c72:	298080e7          	jalr	664(ra) # 5f06 <printf>
    exit(1);
    3c76:	4505                	li	a0,1
    ...
    3c86:	ade50513          	add	a0,a0,-1314 # 7760 <malloc+0x17a2>
    3c8a:	00002097          	auipc	ra,0x2
    3c8e:	27c080e7          	jalr	636(ra) # 5f06 <printf>
    exit(1);
    3c92:	4505                	li	a0,1
    ...
    3ca2:	ae250513          	add	a0,a0,-1310 # 7780 <malloc+0x17c2>
    3ca6:	00002097          	auipc	ra,0x2
    3caa:	260080e7          	jalr	608(ra) # 5f06 <printf>
    exit(1);
    3cae:	4505                	li	a0,1
    ...
    3cbe:	af650513          	add	a0,a0,-1290 # 77b0 <malloc+0x17f2>
    3cc2:	00002097          	auipc	ra,0x2
    3cc6:	244080e7          	jalr	580(ra) # 5f06 <printf>
    exit(1);
    3cca:	4505                	li	a0,1
    ...
    3cda:	b0250513          	add	a0,a0,-1278 # 77d8 <malloc+0x181a>
    3cde:	00002097          	auipc	ra,0x2
    3ce2:	228080e7          	jalr	552(ra) # 5f06 <printf>
    exit(1);
    3ce6:	4505                	li	a0,1
    ...
    3cf6:	b0e50513          	add	a0,a0,-1266 # 7800 <malloc+0x1842>
    3cfa:	00002097          	auipc	ra,0x2
    3cfe:	20c080e7          	jalr	524(ra) # 5f06 <printf>
    exit(1);
    3d02:	4505                	li	a0,1
    ...
    3d12:	b1a50513          	add	a0,a0,-1254 # 7828 <malloc+0x186a>
    3d16:	00002097          	auipc	ra,0x2
    3d1a:	1f0080e7          	jalr	496(ra) # 5f06 <printf>
    exit(1);
    3d1e:	4505                	li	a0,1
    ...
    3d2e:	b1e50513          	add	a0,a0,-1250 # 7848 <malloc+0x188a>
    3d32:	00002097          	auipc	ra,0x2
    3d36:	1d4080e7          	jalr	468(ra) # 5f06 <printf>
    exit(1);
    3d3a:	4505                	li	a0,1
    ...
    3d4a:	b2250513          	add	a0,a0,-1246 # 7868 <malloc+0x18aa>
    3d4e:	00002097          	auipc	ra,0x2
    3d52:	1b8080e7          	jalr	440(ra) # 5f06 <printf>
    exit(1);
    3d56:	4505                	li	a0,1
    ...
    3d66:	b2e50513          	add	a0,a0,-1234 # 7890 <malloc+0x18d2>
    3d6a:	00002097          	auipc	ra,0x2
    3d6e:	19c080e7          	jalr	412(ra) # 5f06 <printf>
    exit(1);
    3d72:	4505                	li	a0,1
    ...
    3d82:	b3250513          	add	a0,a0,-1230 # 78b0 <malloc+0x18f2>
    3d86:	00002097          	auipc	ra,0x2
    3d8a:	180080e7          	jalr	384(ra) # 5f06 <printf>
    exit(1);
    3d8e:	4505                	li	a0,1
    ...
    3d9e:	b3650513          	add	a0,a0,-1226 # 78d0 <malloc+0x1912>
    3da2:	00002097          	auipc	ra,0x2
    3da6:	164080e7          	jalr	356(ra) # 5f06 <printf>
    exit(1);
    3daa:	4505                	li	a0,1
    ...
    3dba:	b4250513          	add	a0,a0,-1214 # 78f8 <malloc+0x193a>
    3dbe:	00002097          	auipc	ra,0x2
    3dc2:	148080e7          	jalr	328(ra) # 5f06 <printf>
    exit(1);
    3dc6:	4505                	li	a0,1
    ...
    3dd6:	7be50513          	add	a0,a0,1982 # 7590 <malloc+0x15d2>
    3dda:	00002097          	auipc	ra,0x2
    3dde:	12c080e7          	jalr	300(ra) # 5f06 <printf>
    exit(1);
    3de2:	4505                	li	a0,1
    ...
    3df2:	b2a50513          	add	a0,a0,-1238 # 7918 <malloc+0x195a>
    3df6:	00002097          	auipc	ra,0x2
    3dfa:	110080e7          	jalr	272(ra) # 5f06 <printf>
    exit(1);
    3dfe:	4505                	li	a0,1
    ...
    3e0e:	b2e50513          	add	a0,a0,-1234 # 7938 <malloc+0x197a>
    3e12:	00002097          	auipc	ra,0x2
    3e16:	0f4080e7          	jalr	244(ra) # 5f06 <printf>
    exit(1);
    3e1a:	4505                	li	a0,1
    ...
    3e2a:	b4250513          	add	a0,a0,-1214 # 7968 <malloc+0x19aa>
    3e2e:	00002097          	auipc	ra,0x2
    3e32:	0d8080e7          	jalr	216(ra) # 5f06 <printf>
    exit(1);
    3e36:	4505                	li	a0,1
    ...
    3e46:	b4650513          	add	a0,a0,-1210 # 7988 <malloc+0x19ca>
    3e4a:	00002097          	auipc	ra,0x2
    3e4e:	0bc080e7          	jalr	188(ra) # 5f06 <printf>
    exit(1);
    3e52:	4505                	li	a0,1
...
0000000000003e5c <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3e6c:	b3850513          	add	a0,a0,-1224 # 79a0 <malloc+0x19e2>
  ...
  if(chdir("dots") != 0){
    ...
    3e7e:	b2650513          	add	a0,a0,-1242 # 79a0 <malloc+0x19e2>
  ...
  if(unlink(".") == 0){
    ...
    3e90:	94450513          	add	a0,a0,-1724 # 67d0 <malloc+0x812>
  ...
  if(unlink("..") == 0){
    ...
    3ea2:	55a50513          	add	a0,a0,1370 # 73f8 <malloc+0x143a>
  ...
  if(chdir("/") != 0){
    ...
    3eb4:	4f050513          	add	a0,a0,1264 # 73a0 <malloc+0x13e2>
  ...
  if(unlink("dots/.") == 0){
    ...
    3ec6:	b4650513          	add	a0,a0,-1210 # 7a08 <malloc+0x1a4a>
  ...
  if(unlink("dots/..") == 0){
    ...
    3ed8:	b5c50513          	add	a0,a0,-1188 # 7a30 <malloc+0x1a72>
  ...
  if(unlink("dots") != 0){
    ...
    3eea:	aba50513          	add	a0,a0,-1350 # 79a0 <malloc+0x19e2>
    ...
    3f08:	aa450513          	add	a0,a0,-1372 # 79a8 <malloc+0x19ea>
    3f0c:	00002097          	auipc	ra,0x2
    3f10:	ffa080e7          	jalr	-6(ra) # 5f06 <printf>
    exit(1);
    3f14:	4505                	li	a0,1
    ...
    3f24:	aa050513          	add	a0,a0,-1376 # 79c0 <malloc+0x1a02>
    3f28:	00002097          	auipc	ra,0x2
    3f2c:	fde080e7          	jalr	-34(ra) # 5f06 <printf>
    exit(1);
    3f30:	4505                	li	a0,1
    ...
    3f40:	a9c50513          	add	a0,a0,-1380 # 79d8 <malloc+0x1a1a>
    3f44:	00002097          	auipc	ra,0x2
    3f48:	fc2080e7          	jalr	-62(ra) # 5f06 <printf>
    exit(1);
    3f4c:	4505                	li	a0,1
    ...
    3f5c:	a9850513          	add	a0,a0,-1384 # 79f0 <malloc+0x1a32>
    3f60:	00002097          	auipc	ra,0x2
    3f64:	fa6080e7          	jalr	-90(ra) # 5f06 <printf>
    exit(1);
    3f68:	4505                	li	a0,1
    ...
    3f78:	43450513          	add	a0,a0,1076 # 73a8 <malloc+0x13ea>
    3f7c:	00002097          	auipc	ra,0x2
    3f80:	f8a080e7          	jalr	-118(ra) # 5f06 <printf>
    exit(1);
    3f84:	4505                	li	a0,1
    ...
    3f94:	a8050513          	add	a0,a0,-1408 # 7a10 <malloc+0x1a52>
    3f98:	00002097          	auipc	ra,0x2
    3f9c:	f6e080e7          	jalr	-146(ra) # 5f06 <printf>
    exit(1);
    3fa0:	4505                	li	a0,1
    ...
    3fb0:	a8c50513          	add	a0,a0,-1396 # 7a38 <malloc+0x1a7a>
    3fb4:	00002097          	auipc	ra,0x2
    3fb8:	f52080e7          	jalr	-174(ra) # 5f06 <printf>
    exit(1);
    3fbc:	4505                	li	a0,1
    ...
    3fcc:	a9050513          	add	a0,a0,-1392 # 7a58 <malloc+0x1a9a>
    3fd0:	00002097          	auipc	ra,0x2
    3fd4:	f36080e7          	jalr	-202(ra) # 5f06 <printf>
    exit(1);
    3fd8:	4505                	li	a0,1
...
0000000000003fe2 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3ff8:	a8450513          	add	a0,a0,-1404 # 7a78 <malloc+0x1aba>
  ...
  if(chdir("dirfile") == 0){
    ...
    4014:	a6850513          	add	a0,a0,-1432 # 7a78 <malloc+0x1aba>
  ...
  fd = open("dirfile/xx", 0);
    ...
    4028:	a9c50513          	add	a0,a0,-1380 # 7ac0 <malloc+0x1b02>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4040:	a8450513          	add	a0,a0,-1404 # 7ac0 <malloc+0x1b02>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    4054:	a7050513          	add	a0,a0,-1424 # 7ac0 <malloc+0x1b02>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    4068:	a5c50513          	add	a0,a0,-1444 # 7ac0 <malloc+0x1b02>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    407c:	a4858593          	add	a1,a1,-1464 # 7ac0 <malloc+0x1b02>
    4080:	00002517          	auipc	a0,0x2
    4084:	24050513          	add	a0,a0,576 # 62c0 <malloc+0x302>
  ...
  if(unlink("dirfile") != 0){
    ...
    4098:	9e450513          	add	a0,a0,-1564 # 7a78 <malloc+0x1aba>
  ...
  fd = open(".", O_RDWR);
    ...
    40ae:	72650513          	add	a0,a0,1830 # 67d0 <malloc+0x812>
  ...
  fd = open(".", 0);
    ...
    40c4:	71050513          	add	a0,a0,1808 # 67d0 <malloc+0x812>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    40d8:	08458593          	add	a1,a1,132 # 6158 <malloc+0x19a>
  ...
  close(fd);
    ...
    4104:	98050513          	add	a0,a0,-1664 # 7a80 <malloc+0x1ac2>
    4108:	00002097          	auipc	ra,0x2
    410c:	dfe080e7          	jalr	-514(ra) # 5f06 <printf>
    exit(1);
    4110:	4505                	li	a0,1
    ...
    4120:	98450513          	add	a0,a0,-1660 # 7aa0 <malloc+0x1ae2>
    4124:	00002097          	auipc	ra,0x2
    4128:	de2080e7          	jalr	-542(ra) # 5f06 <printf>
    exit(1);
    412c:	4505                	li	a0,1
    ...
    413c:	99850513          	add	a0,a0,-1640 # 7ad0 <malloc+0x1b12>
    4140:	00002097          	auipc	ra,0x2
    4144:	dc6080e7          	jalr	-570(ra) # 5f06 <printf>
    exit(1);
    4148:	4505                	li	a0,1
    ...
    4158:	97c50513          	add	a0,a0,-1668 # 7ad0 <malloc+0x1b12>
    415c:	00002097          	auipc	ra,0x2
    4160:	daa080e7          	jalr	-598(ra) # 5f06 <printf>
    exit(1);
    4164:	4505                	li	a0,1
    ...
    4174:	98850513          	add	a0,a0,-1656 # 7af8 <malloc+0x1b3a>
    4178:	00002097          	auipc	ra,0x2
    417c:	d8e080e7          	jalr	-626(ra) # 5f06 <printf>
    exit(1);
    4180:	4505                	li	a0,1
    ...
    4190:	99450513          	add	a0,a0,-1644 # 7b20 <malloc+0x1b62>
    4194:	00002097          	auipc	ra,0x2
    4198:	d72080e7          	jalr	-654(ra) # 5f06 <printf>
    exit(1);
    419c:	4505                	li	a0,1
    ...
    41ac:	9a050513          	add	a0,a0,-1632 # 7b48 <malloc+0x1b8a>
    41b0:	00002097          	auipc	ra,0x2
    41b4:	d56080e7          	jalr	-682(ra) # 5f06 <printf>
    exit(1);
    41b8:	4505                	li	a0,1
    ...
    41c8:	9ac50513          	add	a0,a0,-1620 # 7b70 <malloc+0x1bb2>
    41cc:	00002097          	auipc	ra,0x2
    41d0:	d3a080e7          	jalr	-710(ra) # 5f06 <printf>
    exit(1);
    41d4:	4505                	li	a0,1
    ...
    41e4:	9b050513          	add	a0,a0,-1616 # 7b90 <malloc+0x1bd2>
    41e8:	00002097          	auipc	ra,0x2
    41ec:	d1e080e7          	jalr	-738(ra) # 5f06 <printf>
    exit(1);
    41f0:	4505                	li	a0,1
    ...
    4200:	9bc50513          	add	a0,a0,-1604 # 7bb8 <malloc+0x1bfa>
    4204:	00002097          	auipc	ra,0x2
    4208:	d02080e7          	jalr	-766(ra) # 5f06 <printf>
    exit(1);
    420c:	4505                	li	a0,1
...
0000000000004216 <iref>:
{
    ...
    4234:	9a0a0a13          	add	s4,s4,-1632 # 7bd0 <malloc+0x1c12>
    mkdir("");
    4238:	00003497          	auipc	s1,0x3
    423c:	4a048493          	add	s1,s1,1184 # 76d8 <malloc+0x171a>
    link("README", "");
    4240:	00002a97          	auipc	s5,0x2
    4244:	080a8a93          	add	s5,s5,128 # 62c0 <malloc+0x302>
    fd = open("xx", O_CREATE);
    4248:	00004997          	auipc	s3,0x4
    424c:	88098993          	add	s3,s3,-1920 # 7ac8 <malloc+0x1b0a>
    4250:	a891                	j	42a4 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    4252:	85da                	mv	a1,s6
    4254:	00004517          	auipc	a0,0x4
    4258:	98450513          	add	a0,a0,-1660 # 7bd8 <malloc+0x1c1a>
    425c:	00002097          	auipc	ra,0x2
    4260:	caa080e7          	jalr	-854(ra) # 5f06 <printf>
      exit(1);
    4264:	4505                	li	a0,1
    ...
    4274:	98050513          	add	a0,a0,-1664 # 7bf0 <malloc+0x1c32>
    4278:	00002097          	auipc	ra,0x2
    427c:	c8e080e7          	jalr	-882(ra) # 5f06 <printf>
      exit(1);
    4280:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    4308:	0f498993          	add	s3,s3,244 # 73f8 <malloc+0x143a>
    unlink("irefd");
    430c:	00004917          	auipc	s2,0x4
    4310:	8c490913          	add	s2,s2,-1852 # 7bd0 <malloc+0x1c12>
    chdir("..");
    4314:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4330:	07450513          	add	a0,a0,116 # 73a0 <malloc+0x13e2>
...
0000000000004350 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    4360:	8ac50513          	add	a0,a0,-1876 # 7c08 <malloc+0x1c4a>
  ...
  if(pid == 0){
    ...
    4384:	88850513          	add	a0,a0,-1912 # 7c08 <malloc+0x1c4a>
    ...
    439a:	89250513          	add	a0,a0,-1902 # 7c28 <malloc+0x1c6a>
    439e:	00002097          	auipc	ra,0x2
    43a2:	b68080e7          	jalr	-1176(ra) # 5f06 <printf>
      exit(1);
    43a6:	4505                	li	a0,1
    ...
    43b6:	85e50513          	add	a0,a0,-1954 # 7c10 <malloc+0x1c52>
    43ba:	00002097          	auipc	ra,0x2
    43be:	b4c080e7          	jalr	-1204(ra) # 5f06 <printf>
    exit(1);
    43c2:	4505                	li	a0,1
    ...
    43d2:	5a250513          	add	a0,a0,1442 # 6970 <malloc+0x9b2>
    43d6:	00002097          	auipc	ra,0x2
    43da:	b30080e7          	jalr	-1232(ra) # 5f06 <printf>
    exit(1);
    43de:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    4400:	80c50513          	add	a0,a0,-2036 # 7c08 <malloc+0x1c4a>
    ...
    4414:	75050513          	add	a0,a0,1872 # 6b60 <malloc+0xba2>
    4418:	00002097          	auipc	ra,0x2
    441c:	aee080e7          	jalr	-1298(ra) # 5f06 <printf>
    exit(1);
    4420:	4505                	li	a0,1
...
0000000000004442 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    4452:	80250513          	add	a0,a0,-2046 # 7c50 <malloc+0x1c92>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    447e:	7d650513          	add	a0,a0,2006 # 7c50 <malloc+0x1c92>
  ...
  sleep(10); // one second
    ...
    44b6:	67e50513          	add	a0,a0,1662 # 6b30 <malloc+0xb72>
    44ba:	00002097          	auipc	ra,0x2
    44be:	a4c080e7          	jalr	-1460(ra) # 5f06 <printf>
    exit(1);
    44c2:	4505                	li	a0,1
    ...
    44d0:	78448493          	add	s1,s1,1924 # 7c50 <malloc+0x1c92>
    44d4:	4581                	li	a1,0
    44d6:	8526                	mv	a0,s1
    ...
    44f8:	75c50513          	add	a0,a0,1884 # 7c50 <malloc+0x1c92>
...
0000000000004518 <killstatus>:
{
  ...
  exit(0);
    ...
    457e:	3f650513          	add	a0,a0,1014 # 6970 <malloc+0x9b2>
    4582:	00002097          	auipc	ra,0x2
    4586:	984080e7          	jalr	-1660(ra) # 5f06 <printf>
      exit(1);
    458a:	4505                	li	a0,1
    ...
    45a4:	6c050513          	add	a0,a0,1728 # 7c60 <malloc+0x1ca2>
    45a8:	00002097          	auipc	ra,0x2
    45ac:	95e080e7          	jalr	-1698(ra) # 5f06 <printf>
       exit(1);
    45b0:	4505                	li	a0,1
...
00000000000045ba <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    45e4:	55050513          	add	a0,a0,1360 # 6b30 <malloc+0xb72>
    45e8:	00002097          	auipc	ra,0x2
    45ec:	91e080e7          	jalr	-1762(ra) # 5f06 <printf>
    exit(1);
    45f0:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    4612:	36250513          	add	a0,a0,866 # 6970 <malloc+0x9b2>
    4616:	00002097          	auipc	ra,0x2
    461a:	8f0080e7          	jalr	-1808(ra) # 5f06 <printf>
    exit(1);
    461e:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    4656:	b0658593          	add	a1,a1,-1274 # 6158 <malloc+0x19a>
    ...
    4680:	2f450513          	add	a0,a0,756 # 6970 <malloc+0x9b2>
    4684:	00002097          	auipc	ra,0x2
    4688:	882080e7          	jalr	-1918(ra) # 5f06 <printf>
     exit(1);
    468c:	4505                	li	a0,1
    ...
    469c:	5e850513          	add	a0,a0,1512 # 7c80 <malloc+0x1cc2>
    46a0:	00002097          	auipc	ra,0x2
    46a4:	866080e7          	jalr	-1946(ra) # 5f06 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    46d8:	5c450513          	add	a0,a0,1476 # 7c98 <malloc+0x1cda>
    46dc:	00002097          	auipc	ra,0x2
    46e0:	82a080e7          	jalr	-2006(ra) # 5f06 <printf>
}
  ...
  printf("kill... ");
    ...
    4704:	5b050513          	add	a0,a0,1456 # 7cb0 <malloc+0x1cf2>
    4708:	00001097          	auipc	ra,0x1
    470c:	7fe080e7          	jalr	2046(ra) # 5f06 <printf>
  kill(pid1);
    4710:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    4732:	59250513          	add	a0,a0,1426 # 7cc0 <malloc+0x1d02>
    4736:	00001097          	auipc	ra,0x1
    473a:	7d0080e7          	jalr	2000(ra) # 5f06 <printf>
  wait(0);
    473e:	4501                	li	a0,0
...
000000000000475e <reparent>:
{
  ...
  exit(0);
    ...
    47b2:	1c250513          	add	a0,a0,450 # 6970 <malloc+0x9b2>
    47b6:	00001097          	auipc	ra,0x1
    47ba:	750080e7          	jalr	1872(ra) # 5f06 <printf>
      exit(1);
    47be:	4505                	li	a0,1
    ...
    47ce:	32e50513          	add	a0,a0,814 # 6af8 <malloc+0xb3a>
    47d2:	00001097          	auipc	ra,0x1
    47d6:	734080e7          	jalr	1844(ra) # 5f06 <printf>
        exit(1);
    47da:	4505                	li	a0,1
...
000000000000480e <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    4844:	23850513          	add	a0,a0,568 # 6a78 <malloc+0xaba>
    4848:	00001097          	auipc	ra,0x1
    484c:	6be080e7          	jalr	1726(ra) # 5f06 <printf>
    exit(1);
    4850:	4505                	li	a0,1
    ...
    4878:	8e458593          	add	a1,a1,-1820 # 6158 <malloc+0x19a>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    493c:	39850513          	add	a0,a0,920 # 7cd0 <malloc+0x1d12>
    4940:	00001097          	auipc	ra,0x1
    4944:	5c6080e7          	jalr	1478(ra) # 5f06 <printf>
    exit(1);
    4948:	4505                	li	a0,1
    ...
    4958:	01c50513          	add	a0,a0,28 # 6970 <malloc+0x9b2>
    495c:	00001097          	auipc	ra,0x1
    4960:	5aa080e7          	jalr	1450(ra) # 5f06 <printf>
    exit(1);
    4964:	4505                	li	a0,1
    ...
    49a4:	35050513          	add	a0,a0,848 # 7cf0 <malloc+0x1d32>
    49a8:	00001097          	auipc	ra,0x1
    49ac:	55e080e7          	jalr	1374(ra) # 5f06 <printf>
    exit(1);
    49b0:	4505                	li	a0,1
...
00000000000049c4 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4a0e:	5b4080e7          	jalr	1460(ra) # 5fbe <malloc>
    ...
    4a48:	2dc50513          	add	a0,a0,732 # 7d20 <malloc+0x1d62>
    4a4c:	00001097          	auipc	ra,0x1
    4a50:	4ba080e7          	jalr	1210(ra) # 5f06 <printf>
      exit(1);
    4a54:	4505                	li	a0,1
...
0000000000004a68 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4afe:	25650513          	add	a0,a0,598 # 7d50 <malloc+0x1d92>
    4b02:	00001097          	auipc	ra,0x1
    4b06:	404080e7          	jalr	1028(ra) # 5f06 <printf>
    exit(1);
    4b0a:	4505                	li	a0,1
    ...
    4b1a:	26250513          	add	a0,a0,610 # 7d78 <malloc+0x1dba>
    4b1e:	00001097          	auipc	ra,0x1
    4b22:	3e8080e7          	jalr	1000(ra) # 5f06 <printf>
      exit(1);
    4b26:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    4b5e:	1e650513          	add	a0,a0,486 # 7d40 <malloc+0x1d82>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4b9e:	1fe50513          	add	a0,a0,510 # 7d98 <malloc+0x1dda>
    4ba2:	00001097          	auipc	ra,0x1
    4ba6:	364080e7          	jalr	868(ra) # 5f06 <printf>
    exit(1);
    4baa:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    4bda:	16a50513          	add	a0,a0,362 # 7d40 <malloc+0x1d82>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4c00:	1c450513          	add	a0,a0,452 # 7dc0 <malloc+0x1e02>
    4c04:	00001097          	auipc	ra,0x1
    4c08:	302080e7          	jalr	770(ra) # 5f06 <printf>
    exit(1);
    4c0c:	4505                	li	a0,1
...
0000000000004c20 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4c44:	19878793          	add	a5,a5,408 # 7dd8 <malloc+0x1e1a>
    4c48:	f6f43823          	sd	a5,-144(s0)
    4c4c:	00003797          	auipc	a5,0x3
    4c50:	19478793          	add	a5,a5,404 # 7de0 <malloc+0x1e22>
    4c54:	f6f43c23          	sd	a5,-136(s0)
    4c58:	00003797          	auipc	a5,0x3
    4c5c:	19078793          	add	a5,a5,400 # 7de8 <malloc+0x1e2a>
    4c60:	f8f43023          	sd	a5,-128(s0)
    4c64:	00003797          	auipc	a5,0x3
    4c68:	18c78793          	add	a5,a5,396 # 7df0 <malloc+0x1e32>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4cd6:	0a650513          	add	a0,a0,166 # 6d78 <malloc+0xdba>
    4cda:	00001097          	auipc	ra,0x1
    4cde:	22c080e7          	jalr	556(ra) # 5f06 <printf>
      exit(1);
    4ce2:	4505                	li	a0,1
    ...
    4d50:	0ac50513          	add	a0,a0,172 # 7df8 <malloc+0x1e3a>
    4d54:	00001097          	auipc	ra,0x1
    4d58:	1b2080e7          	jalr	434(ra) # 5f06 <printf>
        exit(1);
    4d5c:	4505                	li	a0,1
    ...
    4d6a:	0a250513          	add	a0,a0,162 # 7e08 <malloc+0x1e4a>
    4d6e:	00001097          	auipc	ra,0x1
    4d72:	198080e7          	jalr	408(ra) # 5f06 <printf>
          exit(1);
    4d76:	4505                	li	a0,1
    ...
    4d90:	09450513          	add	a0,a0,148 # 7e20 <malloc+0x1e62>
    4d94:	00001097          	auipc	ra,0x1
    4d98:	172080e7          	jalr	370(ra) # 5f06 <printf>
          exit(1);
    4d9c:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4e18:	01c50513          	add	a0,a0,28 # 7e30 <malloc+0x1e72>
    4e1c:	00001097          	auipc	ra,0x1
    4e20:	0ea080e7          	jalr	234(ra) # 5f06 <printf>
      exit(1);
    4e24:	4505                	li	a0,1
...
0000000000004e4c <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4e7a:	fd2b8b93          	add	s7,s7,-46 # 7e48 <malloc+0x1e8a>
  for(i = 0; i < N; i++){
    ...
    4ebc:	f9850513          	add	a0,a0,-104 # 7e50 <malloc+0x1e92>
    4ec0:	00001097          	auipc	ra,0x1
    4ec4:	046080e7          	jalr	70(ra) # 5f06 <printf>
        exit(1);
    4ec8:	4505                	li	a0,1
    ...
    4eda:	f7250513          	add	a0,a0,-142 # 7e48 <malloc+0x1e8a>
  ...
  fd = open(".", 0);
    ...
    4f12:	8c250513          	add	a0,a0,-1854 # 67d0 <malloc+0x812>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4f8a:	eea50513          	add	a0,a0,-278 # 7e70 <malloc+0x1eb2>
    4f8e:	00001097          	auipc	ra,0x1
    4f92:	f78080e7          	jalr	-136(ra) # 5f06 <printf>
        exit(1);
    4f96:	4505                	li	a0,1
    ...
    4faa:	eea50513          	add	a0,a0,-278 # 7e90 <malloc+0x1ed2>
    4fae:	00001097          	auipc	ra,0x1
    4fb2:	f58080e7          	jalr	-168(ra) # 5f06 <printf>
        exit(1);
    4fb6:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    4fe2:	eda50513          	add	a0,a0,-294 # 7eb8 <malloc+0x1efa>
    4fe6:	00001097          	auipc	ra,0x1
    4fea:	f20080e7          	jalr	-224(ra) # 5f06 <printf>
    exit(1);
    4fee:	4505                	li	a0,1
    ...
    4ffe:	97650513          	add	a0,a0,-1674 # 6970 <malloc+0x9b2>
    5002:	00001097          	auipc	ra,0x1
    5006:	f04080e7          	jalr	-252(ra) # 5f06 <printf>
      exit(1);
    500a:	4505                	li	a0,1
...
00000000000051a8 <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    5230:	cc450513          	add	a0,a0,-828 # 7ef0 <malloc+0x1f32>
  ...
  for(i = 0; ; i++){
    ...
    5294:	c7050513          	add	a0,a0,-912 # 7f00 <malloc+0x1f42>
    5298:	00001097          	auipc	ra,0x1
    529c:	c6e080e7          	jalr	-914(ra) # 5f06 <printf>
    exit(1);
    52a0:	4505                	li	a0,1
    ...
    52b0:	c7450513          	add	a0,a0,-908 # 7f20 <malloc+0x1f62>
    52b4:	00001097          	auipc	ra,0x1
    52b8:	c52080e7          	jalr	-942(ra) # 5f06 <printf>
      exit(1);
    52bc:	4505                	li	a0,1
    ...
    52cc:	c7850513          	add	a0,a0,-904 # 7f40 <malloc+0x1f82>
    52d0:	00001097          	auipc	ra,0x1
    52d4:	c36080e7          	jalr	-970(ra) # 5f06 <printf>
    exit(1);
    52d8:	4505                	li	a0,1
    ...
    52e8:	c7c50513          	add	a0,a0,-900 # 7f60 <malloc+0x1fa2>
    52ec:	00001097          	auipc	ra,0x1
    52f0:	c1a080e7          	jalr	-998(ra) # 5f06 <printf>
      exit(1);
    52f4:	4505                	li	a0,1
    ...
    5304:	c8050513          	add	a0,a0,-896 # 7f80 <malloc+0x1fc2>
    5308:	00001097          	auipc	ra,0x1
    530c:	bfe080e7          	jalr	-1026(ra) # 5f06 <printf>
      exit(1);
    5310:	4505                	li	a0,1
    ...
    5320:	c7c50513          	add	a0,a0,-900 # 7f98 <malloc+0x1fda>
    5324:	00001097          	auipc	ra,0x1
    5328:	be2080e7          	jalr	-1054(ra) # 5f06 <printf>
      exit(1);
    532c:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    534e:	ba650513          	add	a0,a0,-1114 # 7ef0 <malloc+0x1f32>
    ...
    5372:	c4a50513          	add	a0,a0,-950 # 7fb8 <malloc+0x1ffa>
    5376:	00001097          	auipc	ra,0x1
    537a:	b90080e7          	jalr	-1136(ra) # 5f06 <printf>
    exit(1);
    537e:	4505                	li	a0,1
...
0000000000005388 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    53a8:	c3450513          	add	a0,a0,-972 # 7fd8 <malloc+0x201a>
    53ac:	00001097          	auipc	ra,0x1
    53b0:	b5a080e7          	jalr	-1190(ra) # 5f06 <printf>
  for(nfiles = 0; ; nfiles++){
    53b4:	4481                	li	s1,0
    name[0] = 'f';
    ...
    53c8:	c24c8c93          	add	s9,s9,-988 # 7fe8 <malloc+0x202a>
    name[0] = 'f';
    ...
    5416:	af4080e7          	jalr	-1292(ra) # 5f06 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    5438:	bc450513          	add	a0,a0,-1084 # 7ff8 <malloc+0x203a>
    543c:	00001097          	auipc	ra,0x1
    5440:	aca080e7          	jalr	-1334(ra) # 5f06 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    54ae:	b6e50513          	add	a0,a0,-1170 # 8018 <malloc+0x205a>
    54b2:	00001097          	auipc	ra,0x1
    54b6:	a54080e7          	jalr	-1452(ra) # 5f06 <printf>
}
    ...
    5504:	b0850513          	add	a0,a0,-1272 # 8008 <malloc+0x204a>
    5508:	00001097          	auipc	ra,0x1
    550c:	9fe080e7          	jalr	-1538(ra) # 5f06 <printf>
    close(fd);
    5510:	854a                	mv	a0,s2
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5536:	afe50513          	add	a0,a0,-1282 # 8030 <malloc+0x2072>
    553a:	00001097          	auipc	ra,0x1
    553e:	9cc080e7          	jalr	-1588(ra) # 5f06 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    5566:	af650513          	add	a0,a0,-1290 # 8058 <malloc+0x209a>
    556a:	00001097          	auipc	ra,0x1
    556e:	99c080e7          	jalr	-1636(ra) # 5f06 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    558a:	aba50513          	add	a0,a0,-1350 # 8040 <malloc+0x2082>
    558e:	00001097          	auipc	ra,0x1
    5592:	978080e7          	jalr	-1672(ra) # 5f06 <printf>
    exit(1);
    5596:	4505                	li	a0,1
    ...
    55b2:	ab250513          	add	a0,a0,-1358 # 8060 <malloc+0x20a2>
    55b6:	00001097          	auipc	ra,0x1
    55ba:	950080e7          	jalr	-1712(ra) # 5f06 <printf>
...
runtests(struct test *tests, char *justone) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    5602:	a6a50513          	add	a0,a0,-1430 # 8068 <malloc+0x20aa>
    5606:	00001097          	auipc	ra,0x1
    560a:	900080e7          	jalr	-1792(ra) # 5f06 <printf>
        return 1;
    560e:	4505                	li	a0,1
}
...
countfree()
{
  ...
  if(pid == 0){
    ...
    565c:	b0098993          	add	s3,s3,-1280 # 6158 <malloc+0x19a>
      uint64 a = (uint64) sbrk(4096);
    ...
    568e:	a3650513          	add	a0,a0,-1482 # 80c0 <malloc+0x2102>
    5692:	00001097          	auipc	ra,0x1
    5696:	874080e7          	jalr	-1932(ra) # 5f06 <printf>
        exit(1);
    569a:	4505                	li	a0,1
    ...
    56a8:	9dc50513          	add	a0,a0,-1572 # 8080 <malloc+0x20c2>
    56ac:	00001097          	auipc	ra,0x1
    56b0:	85a080e7          	jalr	-1958(ra) # 5f06 <printf>
    exit(1);
    56b4:	4505                	li	a0,1
    ...
    56c2:	9e250513          	add	a0,a0,-1566 # 80a0 <malloc+0x20e2>
    56c6:	00001097          	auipc	ra,0x1
    56ca:	840080e7          	jalr	-1984(ra) # 5f06 <printf>
    exit(1);
    56ce:	4505                	li	a0,1
  ...
  while(1){
    ...
    5710:	9d450513          	add	a0,a0,-1580 # 80e0 <malloc+0x2122>
    5714:	00000097          	auipc	ra,0x0
    5718:	7f2080e7          	jalr	2034(ra) # 5f06 <printf>
      exit(1);
    571c:	4505                	li	a0,1
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    5772:	992b8b93          	add	s7,s7,-1646 # 8100 <malloc+0x2142>
    int free0 = countfree();
    int free1 = 0;
    ...
    578c:	990d0d13          	add	s10,s10,-1648 # 8118 <malloc+0x215a>
          return 1;
        }
      }
    }
    ...
    5794:	9a8c8c93          	add	s9,s9,-1624 # 8138 <malloc+0x217a>
    5798:	a839                	j	57b6 <drivetests+0x6a>
        printf("usertests slow tests starting\n");
    579a:	856a                	mv	a0,s10
    579c:	00000097          	auipc	ra,0x0
    57a0:	76a080e7          	jalr	1898(ra) # 5f06 <printf>
    ...
    57bc:	74e080e7          	jalr	1870(ra) # 5f06 <printf>
    int free0 = countfree();
    ...
    5804:	706080e7          	jalr	1798(ra) # 5f06 <printf>
      if(continuous != 2) {
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    586c:	90058593          	add	a1,a1,-1792 # 8168 <malloc+0x21aa>
  ...
  char *justone = 0;
    ...
    588a:	8ea58593          	add	a1,a1,-1814 # 8170 <malloc+0x21b2>
    ...
    58a0:	92458593          	add	a1,a1,-1756 # 81c0 <malloc+0x2202>
  ...
  int continuous = 0;
    ...
    58cc:	8b050513          	add	a0,a0,-1872 # 8178 <malloc+0x21ba>
    58d0:	00000097          	auipc	ra,0x0
    58d4:	636080e7          	jalr	1590(ra) # 5f06 <printf>
    exit(1);
    58d8:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    58f2:	8ba50513          	add	a0,a0,-1862 # 81a8 <malloc+0x21ea>
    58f6:	00000097          	auipc	ra,0x0
    58fa:	610080e7          	jalr	1552(ra) # 5f06 <printf>
  exit(0);
    58fe:	4501                	li	a0,0
...
putc(int fd, char c)
{
    5c3e:	1101                	add	sp,sp,-32
    5c40:	ec06                	sd	ra,24(sp)
    5c42:	e822                	sd	s0,16(sp)
    5c44:	1000                	add	s0,sp,32
    5c46:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    5c4a:	4605                	li	a2,1
    5c4c:	fef40593          	add	a1,s0,-17
    5c50:	00000097          	auipc	ra,0x0
    5c54:	f5e080e7          	jalr	-162(ra) # 5bae <write>
}
    5c58:	60e2                	ld	ra,24(sp)
    5c5a:	6442                	ld	s0,16(sp)
    5c5c:	6105                	add	sp,sp,32
    5c5e:	8082                	ret

0000000000005c60 <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
    5c60:	7139                	add	sp,sp,-64
    5c62:	fc06                	sd	ra,56(sp)
    5c64:	f822                	sd	s0,48(sp)
    5c66:	f426                	sd	s1,40(sp)
    5c68:	f04a                	sd	s2,32(sp)
    5c6a:	ec4e                	sd	s3,24(sp)
  ...
  neg = 0;
  if(sgn && xx < 0){
    5c70:	c299                	beqz	a3,5c76 <printint+0x16>
    5c72:	0805c963          	bltz	a1,5d04 <printint+0xa4>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    5c76:	2581                	sext.w	a1,a1
  neg = 0;
    5c78:	4881                	li	a7,0
    5c7a:	fc040693          	add	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    5c80:	2601                	sext.w	a2,a2
    5c82:	00003517          	auipc	a0,0x3
    5c86:	90650513          	add	a0,a0,-1786 # 8588 <digits>
    5c8a:	883a                	mv	a6,a4
    5c8c:	2705                	addw	a4,a4,1
    5c8e:	02c5f7bb          	remuw	a5,a1,a2
    5c92:	1782                	sll	a5,a5,0x20
    5c94:	9381                	srl	a5,a5,0x20
    5c96:	97aa                	add	a5,a5,a0
    5c98:	0007c783          	lbu	a5,0(a5)
    5c9c:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    5ca0:	0005879b          	sext.w	a5,a1
    5ca4:	02c5d5bb          	divuw	a1,a1,a2
    5ca8:	0685                	add	a3,a3,1
    5caa:	fec7f0e3          	bgeu	a5,a2,5c8a <printint+0x2a>
  if(neg)
    5cae:	00088c63          	beqz	a7,5cc6 <printint+0x66>
    buf[i++] = '-';
    5cb2:	fd070793          	add	a5,a4,-48
    5cb6:	00878733          	add	a4,a5,s0
    5cba:	02d00793          	li	a5,45
    5cbe:	fef70823          	sb	a5,-16(a4)
    5cc2:	0028071b          	addw	a4,a6,2

  while(--i >= 0)
    5cc6:	02e05863          	blez	a4,5cf6 <printint+0x96>
    5cca:	fc040793          	add	a5,s0,-64
    5cce:	00e78933          	add	s2,a5,a4
    5cd2:	fff78993          	add	s3,a5,-1
    5cd6:	99ba                	add	s3,s3,a4
    5cd8:	377d                	addw	a4,a4,-1
    5cda:	1702                	sll	a4,a4,0x20
    5cdc:	9301                	srl	a4,a4,0x20
    5cde:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    5ce2:	fff94583          	lbu	a1,-1(s2)
    5ce6:	8526                	mv	a0,s1
    5ce8:	00000097          	auipc	ra,0x0
    5cec:	f56080e7          	jalr	-170(ra) # 5c3e <putc>
  while(--i >= 0)
    5cf0:	197d                	add	s2,s2,-1
    5cf2:	ff3918e3          	bne	s2,s3,5ce2 <printint+0x82>
}
    ...
    5d00:	6121                	add	sp,sp,64
    5d02:	8082                	ret
    x = -xx;
    5d04:	40b005bb          	negw	a1,a1
    neg = 1;
    5d08:	4885                	li	a7,1
    x = -xx;
    5d0a:	bf85                	j	5c7a <printint+0x1a>

0000000000005d0c <vprintf>:
}
...
{
    5d0c:	715d                	add	sp,sp,-80
    5d0e:	e486                	sd	ra,72(sp)
    5d10:	e0a2                	sd	s0,64(sp)
    5d12:	fc26                	sd	s1,56(sp)
    5d14:	f84a                	sd	s2,48(sp)
    5d16:	f44e                	sd	s3,40(sp)
    5d18:	f052                	sd	s4,32(sp)
    5d1a:	ec56                	sd	s5,24(sp)
    5d1c:	e85a                	sd	s6,16(sp)
    5d1e:	e45e                	sd	s7,8(sp)
    5d20:	e062                	sd	s8,0(sp)
    5d22:	0880                	add	s0,sp,80
  char *s;
  int c, i, state;
  ...
  for(i = 0; fmt[i]; i++){
    ...
    5d28:	18090c63          	beqz	s2,5ec0 <vprintf+0x1b4>
    5d2c:	8aaa                	mv	s5,a0
    5d2e:	8bb2                	mv	s7,a2
    5d30:	00158493          	add	s1,a1,1
  state = 0;
    5d34:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    5d3a:	4b55                	li	s6,21
    5d3c:	a839                	j	5d5a <vprintf+0x4e>
        putc(fd, c);
    5d3e:	85ca                	mv	a1,s2
    5d40:	8556                	mv	a0,s5
    5d42:	00000097          	auipc	ra,0x0
    5d46:	efc080e7          	jalr	-260(ra) # 5c3e <putc>
    5d4a:	a019                	j	5d50 <vprintf+0x44>
    } else if(state == '%'){
    5d4c:	01498d63          	beq	s3,s4,5d66 <vprintf+0x5a>
  for(i = 0; fmt[i]; i++){
    5d50:	0485                	add	s1,s1,1
    5d52:	fff4c903          	lbu	s2,-1(s1)
    5d56:	16090563          	beqz	s2,5ec0 <vprintf+0x1b4>
    if(state == 0){
    5d5a:	fe0999e3          	bnez	s3,5d4c <vprintf+0x40>
      if(c == '%'){
    5d5e:	ff4910e3          	bne	s2,s4,5d3e <vprintf+0x32>
        state = '%';
    5d62:	89d2                	mv	s3,s4
    5d64:	b7f5                	j	5d50 <vprintf+0x44>
      if(c == 'd'){
    5d66:	13490263          	beq	s2,s4,5e8a <vprintf+0x17e>
    5d6a:	f9d9079b          	addw	a5,s2,-99
    5d6e:	0ff7f793          	zext.b	a5,a5
    5d72:	12fb6563          	bltu	s6,a5,5e9c <vprintf+0x190>
    5d76:	f9d9079b          	addw	a5,s2,-99
    5d7a:	0ff7f713          	zext.b	a4,a5
    5d7e:	10eb6f63          	bltu	s6,a4,5e9c <vprintf+0x190>
    5d82:	00271793          	sll	a5,a4,0x2
    5d86:	00002717          	auipc	a4,0x2
    5d8a:	7aa70713          	add	a4,a4,1962 # 8530 <malloc+0x2572>
    5d8e:	97ba                	add	a5,a5,a4
    5d90:	439c                	lw	a5,0(a5)
    5d92:	97ba                	add	a5,a5,a4
    5d94:	8782                	jr	a5
        printint(fd, va_arg(ap, int), 10, 1);
    5d96:	008b8913          	add	s2,s7,8
    5d9a:	4685                	li	a3,1
    5d9c:	4629                	li	a2,10
    5d9e:	000ba583          	lw	a1,0(s7)
    5da2:	8556                	mv	a0,s5
    5da4:	00000097          	auipc	ra,0x0
    5da8:	ebc080e7          	jalr	-324(ra) # 5c60 <printint>
    5dac:	8bca                	mv	s7,s2
      } else {
      ...
      state = 0;
    5dae:	4981                	li	s3,0
    5db0:	b745                	j	5d50 <vprintf+0x44>
        printint(fd, va_arg(ap, uint64), 10, 0);
    5db2:	008b8913          	add	s2,s7,8
    5db6:	4681                	li	a3,0
    5db8:	4629                	li	a2,10
    5dba:	000ba583          	lw	a1,0(s7)
    5dbe:	8556                	mv	a0,s5
    5dc0:	00000097          	auipc	ra,0x0
    5dc4:	ea0080e7          	jalr	-352(ra) # 5c60 <printint>
    5dc8:	8bca                	mv	s7,s2
      state = 0;
    5dca:	4981                	li	s3,0
    5dcc:	b751                	j	5d50 <vprintf+0x44>
    ...
    5de0:	e84080e7          	jalr	-380(ra) # 5c60 <printint>
    5de4:	8bca                	mv	s7,s2
      state = 0;
    5de6:	4981                	li	s3,0
    5de8:	b7a5                	j	5d50 <vprintf+0x44>
        printptr(fd, va_arg(ap, uint64));
    5dea:	008b8c13          	add	s8,s7,8
    5dee:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    5df2:	03000593          	li	a1,48
    5df6:	8556                	mv	a0,s5
    5df8:	00000097          	auipc	ra,0x0
    5dfc:	e46080e7          	jalr	-442(ra) # 5c3e <putc>
  putc(fd, 'x');
    5e00:	07800593          	li	a1,120
    5e04:	8556                	mv	a0,s5
    5e06:	00000097          	auipc	ra,0x0
    5e0a:	e38080e7          	jalr	-456(ra) # 5c3e <putc>
    5e0e:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5e10:	00002b97          	auipc	s7,0x2
    5e14:	778b8b93          	add	s7,s7,1912 # 8588 <digits>
    5e18:	03c9d793          	srl	a5,s3,0x3c
    5e1c:	97de                	add	a5,a5,s7
    5e1e:	0007c583          	lbu	a1,0(a5)
    5e22:	8556                	mv	a0,s5
    5e24:	00000097          	auipc	ra,0x0
    5e28:	e1a080e7          	jalr	-486(ra) # 5c3e <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5e2c:	0992                	sll	s3,s3,0x4
    5e2e:	397d                	addw	s2,s2,-1
    5e30:	fe0914e3          	bnez	s2,5e18 <vprintf+0x10c>
        printptr(fd, va_arg(ap, uint64));
    5e34:	8be2                	mv	s7,s8
      state = 0;
    5e36:	4981                	li	s3,0
    5e38:	bf21                	j	5d50 <vprintf+0x44>
        s = va_arg(ap, char*);
    5e3a:	008b8993          	add	s3,s7,8
    5e3e:	000bb903          	ld	s2,0(s7)
        if(s == 0)
    5e42:	02090163          	beqz	s2,5e64 <vprintf+0x158>
        while(*s != 0){
    5e46:	00094583          	lbu	a1,0(s2)
    5e4a:	c9a5                	beqz	a1,5eba <vprintf+0x1ae>
          putc(fd, *s);
    5e4c:	8556                	mv	a0,s5
    5e4e:	00000097          	auipc	ra,0x0
    5e52:	df0080e7          	jalr	-528(ra) # 5c3e <putc>
          s++;
    5e56:	0905                	add	s2,s2,1
        while(*s != 0){
    5e58:	00094583          	lbu	a1,0(s2)
    5e5c:	f9e5                	bnez	a1,5e4c <vprintf+0x140>
        s = va_arg(ap, char*);
    5e5e:	8bce                	mv	s7,s3
      state = 0;
    5e60:	4981                	li	s3,0
    5e62:	b5fd                	j	5d50 <vprintf+0x44>
          s = "(null)";
    5e64:	00002917          	auipc	s2,0x2
    5e68:	6c490913          	add	s2,s2,1732 # 8528 <malloc+0x256a>
        while(*s != 0){
    5e6c:	02800593          	li	a1,40
    5e70:	bff1                	j	5e4c <vprintf+0x140>
        putc(fd, va_arg(ap, uint));
    5e72:	008b8913          	add	s2,s7,8
    5e76:	000bc583          	lbu	a1,0(s7)
    5e7a:	8556                	mv	a0,s5
    5e7c:	00000097          	auipc	ra,0x0
    5e80:	dc2080e7          	jalr	-574(ra) # 5c3e <putc>
    5e84:	8bca                	mv	s7,s2
      state = 0;
    5e86:	4981                	li	s3,0
    5e88:	b5e1                	j	5d50 <vprintf+0x44>
        putc(fd, c);
    5e8a:	02500593          	li	a1,37
    5e8e:	8556                	mv	a0,s5
    5e90:	00000097          	auipc	ra,0x0
    5e94:	dae080e7          	jalr	-594(ra) # 5c3e <putc>
      state = 0;
    5e98:	4981                	li	s3,0
    5e9a:	bd5d                	j	5d50 <vprintf+0x44>
        putc(fd, '%');
    5e9c:	02500593          	li	a1,37
    5ea0:	8556                	mv	a0,s5
    5ea2:	00000097          	auipc	ra,0x0
    5ea6:	d9c080e7          	jalr	-612(ra) # 5c3e <putc>
        putc(fd, c);
    5eaa:	85ca                	mv	a1,s2
    5eac:	8556                	mv	a0,s5
    5eae:	00000097          	auipc	ra,0x0
    5eb2:	d90080e7          	jalr	-624(ra) # 5c3e <putc>
      state = 0;
    5eb6:	4981                	li	s3,0
    5eb8:	bd61                	j	5d50 <vprintf+0x44>
        s = va_arg(ap, char*);
    5eba:	8bce                	mv	s7,s3
      state = 0;
    5ebc:	4981                	li	s3,0
    5ebe:	bd49                	j	5d50 <vprintf+0x44>
    }
  }
}
    5ec0:	60a6                	ld	ra,72(sp)
    5ec2:	6406                	ld	s0,64(sp)
    5ec4:	74e2                	ld	s1,56(sp)
    5ec6:	7942                	ld	s2,48(sp)
    5ec8:	79a2                	ld	s3,40(sp)
    5eca:	7a02                	ld	s4,32(sp)
    5ecc:	6ae2                	ld	s5,24(sp)
    5ece:	6b42                	ld	s6,16(sp)
    5ed0:	6ba2                	ld	s7,8(sp)
    5ed2:	6c02                	ld	s8,0(sp)
    5ed4:	6161                	add	sp,sp,80
    5ed6:	8082                	ret

0000000000005ed8 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    5ed8:	715d                	add	sp,sp,-80
    5eda:	ec06                	sd	ra,24(sp)
    5edc:	e822                	sd	s0,16(sp)
    5ede:	1000                	add	s0,sp,32
    5ee0:	e010                	sd	a2,0(s0)
    5ee2:	e414                	sd	a3,8(s0)
    5ee4:	e818                	sd	a4,16(s0)
    5ee6:	ec1c                	sd	a5,24(s0)
    5ee8:	03043023          	sd	a6,32(s0)
    5eec:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    5ef0:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    5ef4:	8622                	mv	a2,s0
    5ef6:	00000097          	auipc	ra,0x0
    5efa:	e16080e7          	jalr	-490(ra) # 5d0c <vprintf>
}
    5efe:	60e2                	ld	ra,24(sp)
    5f00:	6442                	ld	s0,16(sp)
    5f02:	6161                	add	sp,sp,80
    5f04:	8082                	ret

0000000000005f06 <printf>:

void
printf(const char *fmt, ...)
{
    5f06:	711d                	add	sp,sp,-96
    5f08:	ec06                	sd	ra,24(sp)
    5f0a:	e822                	sd	s0,16(sp)
    5f0c:	1000                	add	s0,sp,32
    5f0e:	e40c                	sd	a1,8(s0)
    5f10:	e810                	sd	a2,16(s0)
    5f12:	ec14                	sd	a3,24(s0)
    5f14:	f018                	sd	a4,32(s0)
    5f16:	f41c                	sd	a5,40(s0)
    5f18:	03043823          	sd	a6,48(s0)
    5f1c:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5f20:	00840613          	add	a2,s0,8
    5f24:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    5f28:	85aa                	mv	a1,a0
    5f2a:	4505                	li	a0,1
    5f2c:	00000097          	auipc	ra,0x0
    5f30:	de0080e7          	jalr	-544(ra) # 5d0c <vprintf>
}
    5f34:	60e2                	ld	ra,24(sp)
    5f36:	6442                	ld	s0,16(sp)
    5f38:	6125                	add	sp,sp,96
    5f3a:	8082                	ret

0000000000005f3c <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    5f3c:	1141                	add	sp,sp,-16
    5f3e:	e422                	sd	s0,8(sp)
    5f40:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5f42:	ff050693          	add	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5f46:	00003797          	auipc	a5,0x3
    5f4a:	50a7b783          	ld	a5,1290(a5) # 9450 <freep>
    5f4e:	a02d                	j	5f78 <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5f50:	4618                	lw	a4,8(a2)
    5f52:	9f2d                	addw	a4,a4,a1
    5f54:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5f58:	6398                	ld	a4,0(a5)
    5f5a:	6310                	ld	a2,0(a4)
    5f5c:	a83d                	j	5f9a <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5f5e:	ff852703          	lw	a4,-8(a0)
    5f62:	9f31                	addw	a4,a4,a2
    5f64:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    5f66:	ff053683          	ld	a3,-16(a0)
    5f6a:	a091                	j	5fae <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5f6c:	6398                	ld	a4,0(a5)
    5f6e:	00e7e463          	bltu	a5,a4,5f76 <free+0x3a>
    5f72:	00e6ea63          	bltu	a3,a4,5f86 <free+0x4a>
{
    5f76:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5f78:	fed7fae3          	bgeu	a5,a3,5f6c <free+0x30>
    5f7c:	6398                	ld	a4,0(a5)
    5f7e:	00e6e463          	bltu	a3,a4,5f86 <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5f82:	fee7eae3          	bltu	a5,a4,5f76 <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    5f86:	ff852583          	lw	a1,-8(a0)
    5f8a:	6390                	ld	a2,0(a5)
    5f8c:	02059813          	sll	a6,a1,0x20
    5f90:	01c85713          	srl	a4,a6,0x1c
    5f94:	9736                	add	a4,a4,a3
    5f96:	fae60de3          	beq	a2,a4,5f50 <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    5f9a:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5f9e:	4790                	lw	a2,8(a5)
    5fa0:	02061593          	sll	a1,a2,0x20
    5fa4:	01c5d713          	srl	a4,a1,0x1c
    5fa8:	973e                	add	a4,a4,a5
    5faa:	fae68ae3          	beq	a3,a4,5f5e <free+0x22>
    p->s.ptr = bp->s.ptr;
    5fae:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    5fb0:	00003717          	auipc	a4,0x3
    5fb4:	4af73023          	sd	a5,1184(a4) # 9450 <freep>
}
    5fb8:	6422                	ld	s0,8(sp)
    5fba:	0141                	add	sp,sp,16
    5fbc:	8082                	ret

0000000000005fbe <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    5fbe:	7139                	add	sp,sp,-64
    5fc0:	fc06                	sd	ra,56(sp)
    5fc2:	f822                	sd	s0,48(sp)
    5fc4:	f426                	sd	s1,40(sp)
    5fc6:	f04a                	sd	s2,32(sp)
    5fc8:	ec4e                	sd	s3,24(sp)
    5fca:	e852                	sd	s4,16(sp)
    5fcc:	e456                	sd	s5,8(sp)
    5fce:	e05a                	sd	s6,0(sp)
    5fd0:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    5fd2:	02051493          	sll	s1,a0,0x20
    5fd6:	9081                	srl	s1,s1,0x20
    5fd8:	04bd                	add	s1,s1,15
    5fda:	8091                	srl	s1,s1,0x4
    5fdc:	0014899b          	addw	s3,s1,1
    5fe0:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
    5fe2:	00003517          	auipc	a0,0x3
    5fe6:	46e53503          	ld	a0,1134(a0) # 9450 <freep>
    5fea:	c515                	beqz	a0,6016 <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5fec:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5fee:	4798                	lw	a4,8(a5)
    5ff0:	02977f63          	bgeu	a4,s1,602e <malloc+0x70>
  if(nu < 4096)
    5ff4:	8a4e                	mv	s4,s3
    5ff6:	0009871b          	sext.w	a4,s3
    5ffa:	6685                	lui	a3,0x1
    5ffc:	00d77363          	bgeu	a4,a3,6002 <malloc+0x44>
    6000:	6a05                	lui	s4,0x1
    6002:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    6006:	004a1a1b          	sllw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    600a:	00003917          	auipc	s2,0x3
    600e:	44690913          	add	s2,s2,1094 # 9450 <freep>
  if(p == (char*)-1)
    6012:	5afd                	li	s5,-1
    6014:	a895                	j	6088 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    6016:	0000a797          	auipc	a5,0xa
    601a:	c6278793          	add	a5,a5,-926 # fc78 <base>
    601e:	00003717          	auipc	a4,0x3
    6022:	42f73923          	sd	a5,1074(a4) # 9450 <freep>
    6026:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    6028:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    602c:	b7e1                	j	5ff4 <malloc+0x36>
      if(p->s.size == nunits)
    602e:	02e48c63          	beq	s1,a4,6066 <malloc+0xa8>
        p->s.size -= nunits;
    6032:	4137073b          	subw	a4,a4,s3
    6036:	c798                	sw	a4,8(a5)
        p += p->s.size;
    6038:	02071693          	sll	a3,a4,0x20
    603c:	01c6d713          	srl	a4,a3,0x1c
    6040:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    6042:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    6046:	00003717          	auipc	a4,0x3
    604a:	40a73523          	sd	a0,1034(a4) # 9450 <freep>
      return (void*)(p + 1);
    604e:	01078513          	add	a0,a5,16
    ...
    6062:	6121                	add	sp,sp,64
    6064:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    6066:	6398                	ld	a4,0(a5)
    6068:	e118                	sd	a4,0(a0)
    606a:	bff1                	j	6046 <malloc+0x88>
  hp->s.size = nu;
    606c:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    6070:	0541                	add	a0,a0,16
    6072:	00000097          	auipc	ra,0x0
    6076:	eca080e7          	jalr	-310(ra) # 5f3c <free>
  return freep;
    607a:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    607e:	d971                	beqz	a0,6052 <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    6080:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    6082:	4798                	lw	a4,8(a5)
    6084:	fa9775e3          	bgeu	a4,s1,602e <malloc+0x70>
    if(p == freep)
    6088:	00093703          	ld	a4,0(s2)
    608c:	853e                	mv	a0,a5
    608e:	fef719e3          	bne	a4,a5,6080 <malloc+0xc2>
  p = sbrk(nu * sizeof(Header));
    6092:	8552                	mv	a0,s4
    6094:	00000097          	auipc	ra,0x0
    6098:	b82080e7          	jalr	-1150(ra) # 5c16 <sbrk>
  if(p == (char*)-1)
    609c:	fd5518e3          	bne	a0,s5,606c <malloc+0xae>
        return 0;
    60a0:	4501                	li	a0,0
    60a2:	bf45                	j	6052 <malloc+0x94>
