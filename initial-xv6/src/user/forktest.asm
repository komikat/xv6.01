...
forktest(void)
{
  ...
  3e:	41e50513          	add	a0,a0,1054 # 458 <getreadcount+0xc>
  ...
  68:	40450513          	add	a0,a0,1028 # 468 <getreadcount+0x1c>
  ...
  b8:	40450513          	add	a0,a0,1028 # 4b8 <getreadcount+0x6c>
  ...
  d4:	3b850513          	add	a0,a0,952 # 488 <getreadcount+0x3c>
  ...
  ee:	3b650513          	add	a0,a0,950 # 4a0 <getreadcount+0x54>
